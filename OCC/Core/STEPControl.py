...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _STEPControl.ios_base_erase_event
    imbue_event = _STEPControl.ios_base_imbue_event
    copyfmt_event = _STEPControl.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _STEPControl.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _STEPControl.ios_base_flags(self, *args)

    def setf(self, *args):
        return _STEPControl.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _STEPControl.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _STEPControl.ios_base_precision(self, *args)

    def width(self, *args):
        return _STEPControl.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _STEPControl.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _STEPControl.ios_base_imbue(self, __loc)

    def getloc(self):
        return _STEPControl.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _STEPControl.ios_base_xalloc()

    def iword(self, __ix):
        return _STEPControl.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _STEPControl.ios_base_pword(self, __ix)
    __swig_destroy__ = _STEPControl.delete_ios_base

# Register ios_base in _STEPControl:
_STEPControl.ios_base_swigregister(ios_base)
cvar = _STEPControl.cvar
ios_base.boolalpha = _STEPControl.cvar.ios_base_boolalpha
ios_base.dec = _STEPControl.cvar.ios_base_dec
ios_base.fixed = _STEPControl.cvar.ios_base_fixed
ios_base.hex = _STEPControl.cvar.ios_base_hex
ios_base.internal = _STEPControl.cvar.ios_base_internal
ios_base.left = _STEPControl.cvar.ios_base_left
ios_base.oct = _STEPControl.cvar.ios_base_oct
ios_base.right = _STEPControl.cvar.ios_base_right
ios_base.scientific = _STEPControl.cvar.ios_base_scientific
ios_base.showbase = _STEPControl.cvar.ios_base_showbase
ios_base.showpoint = _STEPControl.cvar.ios_base_showpoint
ios_base.showpos = _STEPControl.cvar.ios_base_showpos
ios_base.skipws = _STEPControl.cvar.ios_base_skipws
ios_base.unitbuf = _STEPControl.cvar.ios_base_unitbuf
ios_base.uppercase = _STEPControl.cvar.ios_base_uppercase
ios_base.adjustfield = _STEPControl.cvar.ios_base_adjustfield
ios_base.basefield = _STEPControl.cvar.ios_base_basefield
ios_base.floatfield = _STEPControl.cvar.ios_base_floatfield
ios_base.badbit = _STEPControl.cvar.ios_base_badbit
ios_base.eofbit = _STEPControl.cvar.ios_base_eofbit
ios_base.failbit = _STEPControl.cvar.ios_base_failbit
ios_base.goodbit = _STEPControl.cvar.ios_base_goodbit
ios_base.app = _STEPControl.cvar.ios_base_app
ios_base.ate = _STEPControl.cvar.ios_base_ate
ios_base.binary = _STEPControl.cvar.ios_base_binary
ios_base.ios_base_in = _STEPControl.cvar.ios_base_ios_base_in
ios_base.out = _STEPControl.cvar.ios_base_out
ios_base.trunc = _STEPControl.cvar.ios_base_trunc
ios_base.beg = _STEPControl.cvar.ios_base_beg
ios_base.cur = _STEPControl.cvar.ios_base_cur
ios_base.end = _STEPControl.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _STEPControl.ios_rdstate(self)

    def clear(self, *args):
        return _STEPControl.ios_clear(self, *args)

    def setstate(self, __state):
        return _STEPControl.ios_setstate(self, __state)

    def good(self):
        return _STEPControl.ios_good(self)

    def eof(self):
        return _STEPControl.ios_eof(self)

    def fail(self):
        return _STEPControl.ios_fail(self)

    def bad(self):
        return _STEPControl.ios_bad(self)

    def exceptions(self, *args):
        return _STEPControl.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _STEPControl.ios_swiginit(self, _STEPControl.new_ios(__sb))
    __swig_destroy__ = _STEPControl.delete_ios

    def tie(self, *args):
        return _STEPControl.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _STEPControl.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _STEPControl.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _STEPControl.ios_fill(self, *args)

    def imbue(self, __loc):
        return _STEPControl.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _STEPControl.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _STEPControl.ios_widen(self, __c)

# Register ios in _STEPControl:
_STEPControl.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _STEPControl.ostream_swiginit(self, _STEPControl.new_ostream(__sb))
    __swig_destroy__ = _STEPControl.delete_ostream

    def __lshift__(self, *args):
        return _STEPControl.ostream___lshift__(self, *args)

    def put(self, __c):
        return _STEPControl.ostream_put(self, __c)

    def write(self, __s, __n):
        return _STEPControl.ostream_write(self, __s, __n)

    def flush(self):
        return _STEPControl.ostream_flush(self)

    def tellp(self):
        return _STEPControl.ostream_tellp(self)

    def seekp(self, *args):
        return _STEPControl.ostream_seekp(self, *args)

# Register ostream in _STEPControl:
_STEPControl.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _STEPControl.istream_swiginit(self, _STEPControl.new_istream(__sb))
    __swig_destroy__ = _STEPControl.delete_istream

    def __rshift__(self, *args):
        return _STEPControl.istream___rshift__(self, *args)

    def gcount(self):
        return _STEPControl.istream_gcount(self)

    def get(self, *args):
        return _STEPControl.istream_get(self, *args)

    def getline(self, *args):
        return _STEPControl.istream_getline(self, *args)

    def ignore(self, *args):
        return _STEPControl.istream_ignore(self, *args)

    def peek(self):
        return _STEPControl.istream_peek(self)

    def read(self, __s, __n):
        return _STEPControl.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _STEPControl.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _STEPControl.istream_putback(self, __c)

    def unget(self):
        return _STEPControl.istream_unget(self)

    def sync(self):
        return _STEPControl.istream_sync(self)

    def tellg(self):
        return _STEPControl.istream_tellg(self)

    def seekg(self, *args):
        return _STEPControl.istream_seekg(self, *args)

# Register istream in _STEPControl:
_STEPControl.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _STEPControl.iostream_swiginit(self, _STEPControl.new_iostream(__sb))
    __swig_destroy__ = _STEPControl.delete_iostream

# Register iostream in _STEPControl:
_STEPControl.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _STEPControl.endl_cb_ptr
endl = _STEPControl.endl
ends_cb_ptr = _STEPControl.ends_cb_ptr
ends = _STEPControl.ends
flush_cb_ptr = _STEPControl.flush_cb_ptr
flush = _STEPControl.flush
...
class STEPControl_ActorRead(OCC.Core.Transfer.Transfer_ActorOfTransientProcess):
    ...
    def SetModel(self, *args):
        ...
        """
        return _STEPControl.STEPControl_ActorRead_SetModel(self, *args)
...
class STEPControl_Reader(OCC.Core.XSControl.XSControl_Reader):
    ...
    def ReadFile(self, *args):
        ...
        """
        return _STEPControl.STEPControl_Reader_ReadFile(self, *args)
