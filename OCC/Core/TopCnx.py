...
process_exception = _TopCnx.process_exception
...
class TopCnx_EdgeFaceTransition(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TopCnx_EdgeFaceTransition, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TopCnx_EdgeFaceTransition, name)
    __repr__ = _swig_repr
