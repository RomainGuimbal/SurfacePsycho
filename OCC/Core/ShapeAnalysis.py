...
class ShapeAnalysis_FreeBounds(object):
    ...
    @staticmethod
    def ConnectEdgesToWires(edges, toler, shared):
        return _ShapeAnalysis.ShapeAnalysis_FreeBounds_ConnectEdgesToWires(edges, toler, shared)

    @staticmethod
    def ConnectWiresToWires(iwires, toler, shared):
        return _ShapeAnalysis.ShapeAnalysis_FreeBounds_ConnectWiresToWires(iwires, toler, shared)
