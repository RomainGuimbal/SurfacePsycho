...
class intimppargen(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, intimppargen, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, intimppargen, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        this = _IntImpParGen.new_intimppargen()
        try:
