...
class binmdocstd(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, binmdocstd, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, binmdocstd, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        this = _BinMDocStd.new_binmdocstd()
        try:
...
class BinMDocStd_XLinkDriver(OCC.Core.BinMDF.BinMDF_ADriver):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, BinMDocStd_XLinkDriver, name, value)
    __swig_getmethods__ = {}
    for _s in [OCC.Core.BinMDF.BinMDF_ADriver]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, BinMDocStd_XLinkDriver, name)
    __repr__ = _swig_repr
