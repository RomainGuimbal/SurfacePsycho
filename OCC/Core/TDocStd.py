...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_tdocstd.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _TDocStd.ios_base_erase_event
    imbue_event = _TDocStd.ios_base_imbue_event
    copyfmt_event = _TDocStd.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _TDocStd.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _TDocStd.ios_base_flags(self, *args)

    def setf(self, *args):
        return _TDocStd.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _TDocStd.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _TDocStd.ios_base_precision(self, *args)

    def width(self, *args):
        return _TDocStd.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _TDocStd.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _TDocStd.ios_base_imbue(self, __loc)

    def getloc(self):
        return _TDocStd.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _TDocStd.ios_base_xalloc()

    def iword(self, __ix):
        return _TDocStd.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _TDocStd.ios_base_pword(self, __ix)
    __swig_destroy__ = _TDocStd.delete_ios_base

# Register ios_base in _TDocStd:
_TDocStd.ios_base_swigregister(ios_base)
cvar = _TDocStd.cvar
ios_base.boolalpha = _TDocStd.cvar.ios_base_boolalpha
ios_base.dec = _TDocStd.cvar.ios_base_dec
ios_base.fixed = _TDocStd.cvar.ios_base_fixed
ios_base.hex = _TDocStd.cvar.ios_base_hex
ios_base.internal = _TDocStd.cvar.ios_base_internal
ios_base.left = _TDocStd.cvar.ios_base_left
ios_base.oct = _TDocStd.cvar.ios_base_oct
ios_base.right = _TDocStd.cvar.ios_base_right
ios_base.scientific = _TDocStd.cvar.ios_base_scientific
ios_base.showbase = _TDocStd.cvar.ios_base_showbase
ios_base.showpoint = _TDocStd.cvar.ios_base_showpoint
ios_base.showpos = _TDocStd.cvar.ios_base_showpos
ios_base.skipws = _TDocStd.cvar.ios_base_skipws
ios_base.unitbuf = _TDocStd.cvar.ios_base_unitbuf
ios_base.uppercase = _TDocStd.cvar.ios_base_uppercase
ios_base.adjustfield = _TDocStd.cvar.ios_base_adjustfield
ios_base.basefield = _TDocStd.cvar.ios_base_basefield
ios_base.floatfield = _TDocStd.cvar.ios_base_floatfield
ios_base.badbit = _TDocStd.cvar.ios_base_badbit
ios_base.eofbit = _TDocStd.cvar.ios_base_eofbit
ios_base.failbit = _TDocStd.cvar.ios_base_failbit
ios_base.goodbit = _TDocStd.cvar.ios_base_goodbit
ios_base.app = _TDocStd.cvar.ios_base_app
ios_base.ate = _TDocStd.cvar.ios_base_ate
ios_base.binary = _TDocStd.cvar.ios_base_binary
ios_base.ios_base_in = _TDocStd.cvar.ios_base_ios_base_in
ios_base.out = _TDocStd.cvar.ios_base_out
ios_base.trunc = _TDocStd.cvar.ios_base_trunc
ios_base.beg = _TDocStd.cvar.ios_base_beg
ios_base.cur = _TDocStd.cvar.ios_base_cur
ios_base.end = _TDocStd.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _TDocStd.ios_rdstate(self)

    def clear(self, *args):
        return _TDocStd.ios_clear(self, *args)

    def setstate(self, __state):
        return _TDocStd.ios_setstate(self, __state)

    def good(self):
        return _TDocStd.ios_good(self)

    def eof(self):
        return _TDocStd.ios_eof(self)

    def fail(self):
        return _TDocStd.ios_fail(self)

    def bad(self):
        return _TDocStd.ios_bad(self)

    def exceptions(self, *args):
        return _TDocStd.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _TDocStd.ios_swiginit(self, _TDocStd.new_ios(__sb))
    __swig_destroy__ = _TDocStd.delete_ios

    def tie(self, *args):
        return _TDocStd.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _TDocStd.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _TDocStd.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _TDocStd.ios_fill(self, *args)

    def imbue(self, __loc):
        return _TDocStd.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _TDocStd.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _TDocStd.ios_widen(self, __c)

# Register ios in _TDocStd:
_TDocStd.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _TDocStd.ostream_swiginit(self, _TDocStd.new_ostream(__sb))
    __swig_destroy__ = _TDocStd.delete_ostream

    def __lshift__(self, *args):
        return _TDocStd.ostream___lshift__(self, *args)

    def put(self, __c):
        return _TDocStd.ostream_put(self, __c)

    def write(self, __s, __n):
        return _TDocStd.ostream_write(self, __s, __n)

    def flush(self):
        return _TDocStd.ostream_flush(self)

    def tellp(self):
        return _TDocStd.ostream_tellp(self)

    def seekp(self, *args):
        return _TDocStd.ostream_seekp(self, *args)

# Register ostream in _TDocStd:
_TDocStd.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _TDocStd.istream_swiginit(self, _TDocStd.new_istream(__sb))
    __swig_destroy__ = _TDocStd.delete_istream

    def __rshift__(self, *args):
        return _TDocStd.istream___rshift__(self, *args)

    def gcount(self):
        return _TDocStd.istream_gcount(self)

    def get(self, *args):
        return _TDocStd.istream_get(self, *args)

    def getline(self, *args):
        return _TDocStd.istream_getline(self, *args)

    def ignore(self, *args):
        return _TDocStd.istream_ignore(self, *args)

    def peek(self):
        return _TDocStd.istream_peek(self)

    def read(self, __s, __n):
        return _TDocStd.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _TDocStd.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _TDocStd.istream_putback(self, __c)

    def unget(self):
        return _TDocStd.istream_unget(self)

    def sync(self):
        return _TDocStd.istream_sync(self)

    def tellg(self):
        return _TDocStd.istream_tellg(self)

    def seekg(self, *args):
        return _TDocStd.istream_seekg(self, *args)

# Register istream in _TDocStd:
_TDocStd.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _TDocStd.iostream_swiginit(self, _TDocStd.new_iostream(__sb))
    __swig_destroy__ = _TDocStd.delete_iostream

# Register iostream in _TDocStd:
_TDocStd.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _TDocStd.endl_cb_ptr
endl = _TDocStd.endl
ends_cb_ptr = _TDocStd.ends_cb_ptr
ends = _TDocStd.ends
flush_cb_ptr = _TDocStd.flush_cb_ptr
flush = _TDocStd.flush
...
class TDocStd_LabelIDMapDataMap(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Bound(self, *args):
        return _TDocStd.TDocStd_LabelIDMapDataMap_Bound(self, *args)
...
class TDocStd_Application(OCC.Core.CDF.CDF_Application):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _TDocStd.TDocStd_Application_DumpJson(self, depth)
...
class TDocStd_Document(OCC.Core.CDM.CDM_Document):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _TDocStd.TDocStd_Document_DumpJson(self, depth)
...
class TDocStd_Owner(OCC.Core.TDF.TDF_Attribute):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _TDocStd.TDocStd_Owner_DumpJson(self, depth)
