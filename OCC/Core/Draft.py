...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _Draft.ios_base_erase_event
    imbue_event = _Draft.ios_base_imbue_event
    copyfmt_event = _Draft.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _Draft.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _Draft.ios_base_flags(self, *args)

    def setf(self, *args):
        return _Draft.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _Draft.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _Draft.ios_base_precision(self, *args)

    def width(self, *args):
        return _Draft.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _Draft.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _Draft.ios_base_imbue(self, __loc)

    def getloc(self):
        return _Draft.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _Draft.ios_base_xalloc()

    def iword(self, __ix):
        return _Draft.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _Draft.ios_base_pword(self, __ix)
    __swig_destroy__ = _Draft.delete_ios_base

# Register ios_base in _Draft:
_Draft.ios_base_swigregister(ios_base)
cvar = _Draft.cvar
ios_base.boolalpha = _Draft.cvar.ios_base_boolalpha
ios_base.dec = _Draft.cvar.ios_base_dec
ios_base.fixed = _Draft.cvar.ios_base_fixed
ios_base.hex = _Draft.cvar.ios_base_hex
ios_base.internal = _Draft.cvar.ios_base_internal
ios_base.left = _Draft.cvar.ios_base_left
ios_base.oct = _Draft.cvar.ios_base_oct
ios_base.right = _Draft.cvar.ios_base_right
ios_base.scientific = _Draft.cvar.ios_base_scientific
ios_base.showbase = _Draft.cvar.ios_base_showbase
ios_base.showpoint = _Draft.cvar.ios_base_showpoint
ios_base.showpos = _Draft.cvar.ios_base_showpos
ios_base.skipws = _Draft.cvar.ios_base_skipws
ios_base.unitbuf = _Draft.cvar.ios_base_unitbuf
ios_base.uppercase = _Draft.cvar.ios_base_uppercase
ios_base.adjustfield = _Draft.cvar.ios_base_adjustfield
ios_base.basefield = _Draft.cvar.ios_base_basefield
ios_base.floatfield = _Draft.cvar.ios_base_floatfield
ios_base.badbit = _Draft.cvar.ios_base_badbit
ios_base.eofbit = _Draft.cvar.ios_base_eofbit
ios_base.failbit = _Draft.cvar.ios_base_failbit
ios_base.goodbit = _Draft.cvar.ios_base_goodbit
ios_base.app = _Draft.cvar.ios_base_app
ios_base.ate = _Draft.cvar.ios_base_ate
ios_base.binary = _Draft.cvar.ios_base_binary
ios_base.ios_base_in = _Draft.cvar.ios_base_ios_base_in
ios_base.out = _Draft.cvar.ios_base_out
ios_base.trunc = _Draft.cvar.ios_base_trunc
ios_base.beg = _Draft.cvar.ios_base_beg
ios_base.cur = _Draft.cvar.ios_base_cur
ios_base.end = _Draft.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _Draft.ios_rdstate(self)

    def clear(self, *args):
        return _Draft.ios_clear(self, *args)

    def setstate(self, __state):
        return _Draft.ios_setstate(self, __state)

    def good(self):
        return _Draft.ios_good(self)

    def eof(self):
        return _Draft.ios_eof(self)

    def fail(self):
        return _Draft.ios_fail(self)

    def bad(self):
        return _Draft.ios_bad(self)

    def exceptions(self, *args):
        return _Draft.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _Draft.ios_swiginit(self, _Draft.new_ios(__sb))
    __swig_destroy__ = _Draft.delete_ios

    def tie(self, *args):
        return _Draft.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _Draft.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _Draft.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _Draft.ios_fill(self, *args)

    def imbue(self, __loc):
        return _Draft.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _Draft.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _Draft.ios_widen(self, __c)

# Register ios in _Draft:
_Draft.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Draft.ostream_swiginit(self, _Draft.new_ostream(__sb))
    __swig_destroy__ = _Draft.delete_ostream

    def __lshift__(self, *args):
        return _Draft.ostream___lshift__(self, *args)

    def put(self, __c):
        return _Draft.ostream_put(self, __c)

    def write(self, __s, __n):
        return _Draft.ostream_write(self, __s, __n)

    def flush(self):
        return _Draft.ostream_flush(self)

    def tellp(self):
        return _Draft.ostream_tellp(self)

    def seekp(self, *args):
        return _Draft.ostream_seekp(self, *args)

# Register ostream in _Draft:
_Draft.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Draft.istream_swiginit(self, _Draft.new_istream(__sb))
    __swig_destroy__ = _Draft.delete_istream

    def __rshift__(self, *args):
        return _Draft.istream___rshift__(self, *args)

    def gcount(self):
        return _Draft.istream_gcount(self)

    def get(self, *args):
        return _Draft.istream_get(self, *args)

    def getline(self, *args):
        return _Draft.istream_getline(self, *args)

    def ignore(self, *args):
        return _Draft.istream_ignore(self, *args)

    def peek(self):
        return _Draft.istream_peek(self)

    def read(self, __s, __n):
        return _Draft.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _Draft.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _Draft.istream_putback(self, __c)

    def unget(self):
        return _Draft.istream_unget(self)

    def sync(self):
        return _Draft.istream_sync(self)

    def tellg(self):
        return _Draft.istream_tellg(self)

    def seekg(self, *args):
        return _Draft.istream_seekg(self, *args)

# Register istream in _Draft:
_Draft.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Draft.iostream_swiginit(self, _Draft.new_iostream(__sb))
    __swig_destroy__ = _Draft.delete_iostream

# Register iostream in _Draft:
_Draft.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _Draft.endl_cb_ptr
endl = _Draft.endl
ends_cb_ptr = _Draft.ends_cb_ptr
ends = _Draft.ends
flush_cb_ptr = _Draft.flush_cb_ptr
flush = _Draft.flush
...
class Draft_IndexedDataMapOfEdgeEdgeInfo(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _Draft.Draft_IndexedDataMapOfEdgeEdgeInfo_Set(self, *args)

    def ReSize(self, N):
        return _Draft.Draft_IndexedDataMapOfEdgeEdgeInfo_ReSize(self, N)

    def Add(self, *args):
        return _Draft.Draft_IndexedDataMapOfEdgeEdgeInfo_Add(self, *args)
...
class Draft_IndexedDataMapOfFaceFaceInfo(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _Draft.Draft_IndexedDataMapOfFaceFaceInfo_Set(self, *args)

    def ReSize(self, N):
        return _Draft.Draft_IndexedDataMapOfFaceFaceInfo_ReSize(self, N)

    def Add(self, *args):
        return _Draft.Draft_IndexedDataMapOfFaceFaceInfo_Add(self, *args)
...
class Draft_IndexedDataMapOfVertexVertexInfo(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _Draft.Draft_IndexedDataMapOfVertexVertexInfo_Set(self, *args)

    def ReSize(self, N):
        return _Draft.Draft_IndexedDataMapOfVertexVertexInfo_ReSize(self, N)

    def Add(self, *args):
        return _Draft.Draft_IndexedDataMapOfVertexVertexInfo_Add(self, *args)
