...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _Quantity.ios_base_erase_event
    imbue_event = _Quantity.ios_base_imbue_event
    copyfmt_event = _Quantity.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _Quantity.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _Quantity.ios_base_flags(self, *args)

    def setf(self, *args):
        return _Quantity.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _Quantity.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _Quantity.ios_base_precision(self, *args)

    def width(self, *args):
        return _Quantity.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _Quantity.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _Quantity.ios_base_imbue(self, __loc)

    def getloc(self):
        return _Quantity.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _Quantity.ios_base_xalloc()

    def iword(self, __ix):
        return _Quantity.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _Quantity.ios_base_pword(self, __ix)
    __swig_destroy__ = _Quantity.delete_ios_base

# Register ios_base in _Quantity:
_Quantity.ios_base_swigregister(ios_base)
cvar = _Quantity.cvar
ios_base.boolalpha = _Quantity.cvar.ios_base_boolalpha
ios_base.dec = _Quantity.cvar.ios_base_dec
ios_base.fixed = _Quantity.cvar.ios_base_fixed
ios_base.hex = _Quantity.cvar.ios_base_hex
ios_base.internal = _Quantity.cvar.ios_base_internal
ios_base.left = _Quantity.cvar.ios_base_left
ios_base.oct = _Quantity.cvar.ios_base_oct
ios_base.right = _Quantity.cvar.ios_base_right
ios_base.scientific = _Quantity.cvar.ios_base_scientific
ios_base.showbase = _Quantity.cvar.ios_base_showbase
ios_base.showpoint = _Quantity.cvar.ios_base_showpoint
ios_base.showpos = _Quantity.cvar.ios_base_showpos
ios_base.skipws = _Quantity.cvar.ios_base_skipws
ios_base.unitbuf = _Quantity.cvar.ios_base_unitbuf
ios_base.uppercase = _Quantity.cvar.ios_base_uppercase
ios_base.adjustfield = _Quantity.cvar.ios_base_adjustfield
ios_base.basefield = _Quantity.cvar.ios_base_basefield
ios_base.floatfield = _Quantity.cvar.ios_base_floatfield
ios_base.badbit = _Quantity.cvar.ios_base_badbit
ios_base.eofbit = _Quantity.cvar.ios_base_eofbit
ios_base.failbit = _Quantity.cvar.ios_base_failbit
ios_base.goodbit = _Quantity.cvar.ios_base_goodbit
ios_base.app = _Quantity.cvar.ios_base_app
ios_base.ate = _Quantity.cvar.ios_base_ate
ios_base.binary = _Quantity.cvar.ios_base_binary
ios_base.ios_base_in = _Quantity.cvar.ios_base_ios_base_in
ios_base.out = _Quantity.cvar.ios_base_out
ios_base.trunc = _Quantity.cvar.ios_base_trunc
ios_base.beg = _Quantity.cvar.ios_base_beg
ios_base.cur = _Quantity.cvar.ios_base_cur
ios_base.end = _Quantity.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _Quantity.ios_rdstate(self)

    def clear(self, *args):
        return _Quantity.ios_clear(self, *args)

    def setstate(self, __state):
        return _Quantity.ios_setstate(self, __state)

    def good(self):
        return _Quantity.ios_good(self)

    def eof(self):
        return _Quantity.ios_eof(self)

    def fail(self):
        return _Quantity.ios_fail(self)

    def bad(self):
        return _Quantity.ios_bad(self)

    def exceptions(self, *args):
        return _Quantity.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _Quantity.ios_swiginit(self, _Quantity.new_ios(__sb))
    __swig_destroy__ = _Quantity.delete_ios

    def tie(self, *args):
        return _Quantity.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _Quantity.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _Quantity.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _Quantity.ios_fill(self, *args)

    def imbue(self, __loc):
        return _Quantity.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _Quantity.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _Quantity.ios_widen(self, __c)

# Register ios in _Quantity:
_Quantity.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Quantity.ostream_swiginit(self, _Quantity.new_ostream(__sb))
    __swig_destroy__ = _Quantity.delete_ostream

    def __lshift__(self, *args):
        return _Quantity.ostream___lshift__(self, *args)

    def put(self, __c):
        return _Quantity.ostream_put(self, __c)

    def write(self, __s, __n):
        return _Quantity.ostream_write(self, __s, __n)

    def flush(self):
        return _Quantity.ostream_flush(self)

    def tellp(self):
        return _Quantity.ostream_tellp(self)

    def seekp(self, *args):
        return _Quantity.ostream_seekp(self, *args)

# Register ostream in _Quantity:
_Quantity.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Quantity.istream_swiginit(self, _Quantity.new_istream(__sb))
    __swig_destroy__ = _Quantity.delete_istream

    def __rshift__(self, *args):
        return _Quantity.istream___rshift__(self, *args)

    def gcount(self):
        return _Quantity.istream_gcount(self)

    def get(self, *args):
        return _Quantity.istream_get(self, *args)

    def getline(self, *args):
        return _Quantity.istream_getline(self, *args)

    def ignore(self, *args):
        return _Quantity.istream_ignore(self, *args)

    def peek(self):
        return _Quantity.istream_peek(self)

    def read(self, __s, __n):
        return _Quantity.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _Quantity.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _Quantity.istream_putback(self, __c)

    def unget(self):
        return _Quantity.istream_unget(self)

    def sync(self):
        return _Quantity.istream_sync(self)

    def tellg(self):
        return _Quantity.istream_tellg(self)

    def seekg(self, *args):
        return _Quantity.istream_seekg(self, *args)

# Register istream in _Quantity:
_Quantity.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Quantity.iostream_swiginit(self, _Quantity.new_iostream(__sb))
    __swig_destroy__ = _Quantity.delete_iostream

# Register iostream in _Quantity:
_Quantity.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _Quantity.endl_cb_ptr
endl = _Quantity.endl
ends_cb_ptr = _Quantity.ends_cb_ptr
ends = _Quantity.ends
flush_cb_ptr = _Quantity.flush_cb_ptr
flush = _Quantity.flush
...
class Quantity_Array1OfColor(object):
    ...
    def begin(self, *args):
        return _Quantity.Quantity_Array1OfColor_begin(self, *args)

    def cbegin(self):
        return _Quantity.Quantity_Array1OfColor_cbegin(self)

    def end(self, *args):
        return _Quantity.Quantity_Array1OfColor_end(self, *args)
    ...
    def Move(self, *args):
        return _Quantity.Quantity_Array1OfColor_Move(self, *args)
    ...
    def UpdateLowerBound(self, theLower):
        return _Quantity.Quantity_Array1OfColor_UpdateLowerBound(self, theLower)

    def UpdateUpperBound(self, theUpper):
        return _Quantity.Quantity_Array1OfColor_UpdateUpperBound(self, theUpper)
...
class Quantity_Color(object):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _Quantity.Quantity_Color_DumpJson(self, depth)
    ...
    def InitFromJson(self, json_string):
        ...
        """
        return _Quantity.Quantity_Color_InitFromJson(self, json_string)
...
class Quantity_ColorRGBA(object):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _Quantity.Quantity_ColorRGBA_DumpJson(self, depth)
    ...
    def InitFromJson(self, json_string):
        ...
        """
        return _Quantity.Quantity_ColorRGBA_InitFromJson(self, json_string)
