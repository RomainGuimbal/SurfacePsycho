...
process_exception = _IntStart.process_exception
...
def Handle_IntStart_SITopolTool_Create() -> "opencascade::handle< IntStart_SITopolTool >":
    return _IntStart.Handle_IntStart_SITopolTool_Create()
Handle_IntStart_SITopolTool_Create = _IntStart.Handle_IntStart_SITopolTool_Create

def Handle_IntStart_SITopolTool_DownCast(t: 'opencascade::handle< Standard_Transient > const &') -> "opencascade::handle< IntStart_SITopolTool >":
...
def Handle_IntStart_SITopolTool_IsNull(t: 'opencascade::handle< IntStart_SITopolTool > const &') -> "bool":
    return _IntStart.Handle_IntStart_SITopolTool_IsNull(t)
Handle_IntStart_SITopolTool_IsNull = _IntStart.Handle_IntStart_SITopolTool_IsNull
class IntStart_SITopolTool(OCC.Core.Standard.Standard_Transient):
    __swig_setmethods__ = {}
    for _s in [OCC.Core.Standard.Standard_Transient]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, IntStart_SITopolTool, name, value)
    __swig_getmethods__ = {}
    for _s in [OCC.Core.Standard.Standard_Transient]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, IntStart_SITopolTool, name)
