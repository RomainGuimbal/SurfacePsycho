...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _V3d.ios_base_erase_event
    imbue_event = _V3d.ios_base_imbue_event
    copyfmt_event = _V3d.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _V3d.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _V3d.ios_base_flags(self, *args)

    def setf(self, *args):
        return _V3d.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _V3d.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _V3d.ios_base_precision(self, *args)

    def width(self, *args):
        return _V3d.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _V3d.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _V3d.ios_base_imbue(self, __loc)

    def getloc(self):
        return _V3d.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _V3d.ios_base_xalloc()

    def iword(self, __ix):
        return _V3d.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _V3d.ios_base_pword(self, __ix)
    __swig_destroy__ = _V3d.delete_ios_base

# Register ios_base in _V3d:
_V3d.ios_base_swigregister(ios_base)
cvar = _V3d.cvar
ios_base.boolalpha = _V3d.cvar.ios_base_boolalpha
ios_base.dec = _V3d.cvar.ios_base_dec
ios_base.fixed = _V3d.cvar.ios_base_fixed
ios_base.hex = _V3d.cvar.ios_base_hex
ios_base.internal = _V3d.cvar.ios_base_internal
ios_base.left = _V3d.cvar.ios_base_left
ios_base.oct = _V3d.cvar.ios_base_oct
ios_base.right = _V3d.cvar.ios_base_right
ios_base.scientific = _V3d.cvar.ios_base_scientific
ios_base.showbase = _V3d.cvar.ios_base_showbase
ios_base.showpoint = _V3d.cvar.ios_base_showpoint
ios_base.showpos = _V3d.cvar.ios_base_showpos
ios_base.skipws = _V3d.cvar.ios_base_skipws
ios_base.unitbuf = _V3d.cvar.ios_base_unitbuf
ios_base.uppercase = _V3d.cvar.ios_base_uppercase
ios_base.adjustfield = _V3d.cvar.ios_base_adjustfield
ios_base.basefield = _V3d.cvar.ios_base_basefield
ios_base.floatfield = _V3d.cvar.ios_base_floatfield
ios_base.badbit = _V3d.cvar.ios_base_badbit
ios_base.eofbit = _V3d.cvar.ios_base_eofbit
ios_base.failbit = _V3d.cvar.ios_base_failbit
ios_base.goodbit = _V3d.cvar.ios_base_goodbit
ios_base.app = _V3d.cvar.ios_base_app
ios_base.ate = _V3d.cvar.ios_base_ate
ios_base.binary = _V3d.cvar.ios_base_binary
ios_base.ios_base_in = _V3d.cvar.ios_base_ios_base_in
ios_base.out = _V3d.cvar.ios_base_out
ios_base.trunc = _V3d.cvar.ios_base_trunc
ios_base.beg = _V3d.cvar.ios_base_beg
ios_base.cur = _V3d.cvar.ios_base_cur
ios_base.end = _V3d.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _V3d.ios_rdstate(self)

    def clear(self, *args):
        return _V3d.ios_clear(self, *args)

    def setstate(self, __state):
        return _V3d.ios_setstate(self, __state)

    def good(self):
        return _V3d.ios_good(self)

    def eof(self):
        return _V3d.ios_eof(self)

    def fail(self):
        return _V3d.ios_fail(self)

    def bad(self):
        return _V3d.ios_bad(self)

    def exceptions(self, *args):
        return _V3d.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _V3d.ios_swiginit(self, _V3d.new_ios(__sb))
    __swig_destroy__ = _V3d.delete_ios

    def tie(self, *args):
        return _V3d.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _V3d.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _V3d.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _V3d.ios_fill(self, *args)

    def imbue(self, __loc):
        return _V3d.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _V3d.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _V3d.ios_widen(self, __c)

# Register ios in _V3d:
_V3d.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _V3d.ostream_swiginit(self, _V3d.new_ostream(__sb))
    __swig_destroy__ = _V3d.delete_ostream

    def __lshift__(self, *args):
        return _V3d.ostream___lshift__(self, *args)

    def put(self, __c):
        return _V3d.ostream_put(self, __c)

    def write(self, __s, __n):
        return _V3d.ostream_write(self, __s, __n)

    def flush(self):
        return _V3d.ostream_flush(self)

    def tellp(self):
        return _V3d.ostream_tellp(self)

    def seekp(self, *args):
        return _V3d.ostream_seekp(self, *args)

# Register ostream in _V3d:
_V3d.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _V3d.istream_swiginit(self, _V3d.new_istream(__sb))
    __swig_destroy__ = _V3d.delete_istream

    def __rshift__(self, *args):
        return _V3d.istream___rshift__(self, *args)

    def gcount(self):
        return _V3d.istream_gcount(self)

    def get(self, *args):
        return _V3d.istream_get(self, *args)

    def getline(self, *args):
        return _V3d.istream_getline(self, *args)

    def ignore(self, *args):
        return _V3d.istream_ignore(self, *args)

    def peek(self):
        return _V3d.istream_peek(self)

    def read(self, __s, __n):
        return _V3d.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _V3d.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _V3d.istream_putback(self, __c)

    def unget(self):
        return _V3d.istream_unget(self)

    def sync(self):
        return _V3d.istream_sync(self)

    def tellg(self):
        return _V3d.istream_tellg(self)

    def seekg(self, *args):
        return _V3d.istream_seekg(self, *args)

# Register istream in _V3d:
_V3d.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _V3d.iostream_swiginit(self, _V3d.new_iostream(__sb))
    __swig_destroy__ = _V3d.delete_iostream

# Register iostream in _V3d:
_V3d.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _V3d.endl_cb_ptr
endl = _V3d.endl
ends_cb_ptr = _V3d.ends_cb_ptr
ends = _V3d.ends
flush_cb_ptr = _V3d.flush_cb_ptr
flush = _V3d.flush
...
class V3d_ListOfLight(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _V3d.V3d_ListOfLight_Set(self, *args)
...
class V3d_ListOfView(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _V3d.V3d_ListOfView_Set(self, *args)
...
class V3d_CircularGrid(object):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _V3d.V3d_CircularGrid_DumpJson(self, depth)
...
class V3d_RectangularGrid(object):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _V3d.V3d_RectangularGrid_DumpJson(self, depth)
...
class V3d_Trihedron(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _V3d.V3d_Trihedron_DumpJson(self, depth)
...
class V3d_View(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _V3d.V3d_View_DumpJson(self, depth)
...
class V3d_Viewer(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _V3d.V3d_Viewer_DumpJson(self, depth)
