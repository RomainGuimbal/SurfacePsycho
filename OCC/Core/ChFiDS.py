...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_chfids.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _ChFiDS.ios_base_erase_event
    imbue_event = _ChFiDS.ios_base_imbue_event
    copyfmt_event = _ChFiDS.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _ChFiDS.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _ChFiDS.ios_base_flags(self, *args)

    def setf(self, *args):
        return _ChFiDS.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _ChFiDS.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _ChFiDS.ios_base_precision(self, *args)

    def width(self, *args):
        return _ChFiDS.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _ChFiDS.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _ChFiDS.ios_base_imbue(self, __loc)

    def getloc(self):
        return _ChFiDS.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _ChFiDS.ios_base_xalloc()

    def iword(self, __ix):
        return _ChFiDS.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _ChFiDS.ios_base_pword(self, __ix)
    __swig_destroy__ = _ChFiDS.delete_ios_base

# Register ios_base in _ChFiDS:
_ChFiDS.ios_base_swigregister(ios_base)
cvar = _ChFiDS.cvar
ios_base.boolalpha = _ChFiDS.cvar.ios_base_boolalpha
ios_base.dec = _ChFiDS.cvar.ios_base_dec
ios_base.fixed = _ChFiDS.cvar.ios_base_fixed
ios_base.hex = _ChFiDS.cvar.ios_base_hex
ios_base.internal = _ChFiDS.cvar.ios_base_internal
ios_base.left = _ChFiDS.cvar.ios_base_left
ios_base.oct = _ChFiDS.cvar.ios_base_oct
ios_base.right = _ChFiDS.cvar.ios_base_right
ios_base.scientific = _ChFiDS.cvar.ios_base_scientific
ios_base.showbase = _ChFiDS.cvar.ios_base_showbase
ios_base.showpoint = _ChFiDS.cvar.ios_base_showpoint
ios_base.showpos = _ChFiDS.cvar.ios_base_showpos
ios_base.skipws = _ChFiDS.cvar.ios_base_skipws
ios_base.unitbuf = _ChFiDS.cvar.ios_base_unitbuf
ios_base.uppercase = _ChFiDS.cvar.ios_base_uppercase
ios_base.adjustfield = _ChFiDS.cvar.ios_base_adjustfield
ios_base.basefield = _ChFiDS.cvar.ios_base_basefield
ios_base.floatfield = _ChFiDS.cvar.ios_base_floatfield
ios_base.badbit = _ChFiDS.cvar.ios_base_badbit
ios_base.eofbit = _ChFiDS.cvar.ios_base_eofbit
ios_base.failbit = _ChFiDS.cvar.ios_base_failbit
ios_base.goodbit = _ChFiDS.cvar.ios_base_goodbit
ios_base.app = _ChFiDS.cvar.ios_base_app
ios_base.ate = _ChFiDS.cvar.ios_base_ate
ios_base.binary = _ChFiDS.cvar.ios_base_binary
ios_base.ios_base_in = _ChFiDS.cvar.ios_base_ios_base_in
ios_base.out = _ChFiDS.cvar.ios_base_out
ios_base.trunc = _ChFiDS.cvar.ios_base_trunc
ios_base.beg = _ChFiDS.cvar.ios_base_beg
ios_base.cur = _ChFiDS.cvar.ios_base_cur
ios_base.end = _ChFiDS.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _ChFiDS.ios_rdstate(self)

    def clear(self, *args):
        return _ChFiDS.ios_clear(self, *args)

    def setstate(self, __state):
        return _ChFiDS.ios_setstate(self, __state)

    def good(self):
        return _ChFiDS.ios_good(self)

    def eof(self):
        return _ChFiDS.ios_eof(self)

    def fail(self):
        return _ChFiDS.ios_fail(self)

    def bad(self):
        return _ChFiDS.ios_bad(self)

    def exceptions(self, *args):
        return _ChFiDS.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _ChFiDS.ios_swiginit(self, _ChFiDS.new_ios(__sb))
    __swig_destroy__ = _ChFiDS.delete_ios

    def tie(self, *args):
        return _ChFiDS.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _ChFiDS.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _ChFiDS.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _ChFiDS.ios_fill(self, *args)

    def imbue(self, __loc):
        return _ChFiDS.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _ChFiDS.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _ChFiDS.ios_widen(self, __c)

# Register ios in _ChFiDS:
_ChFiDS.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _ChFiDS.ostream_swiginit(self, _ChFiDS.new_ostream(__sb))
    __swig_destroy__ = _ChFiDS.delete_ostream

    def __lshift__(self, *args):
        return _ChFiDS.ostream___lshift__(self, *args)

    def put(self, __c):
        return _ChFiDS.ostream_put(self, __c)

    def write(self, __s, __n):
        return _ChFiDS.ostream_write(self, __s, __n)

    def flush(self):
        return _ChFiDS.ostream_flush(self)

    def tellp(self):
        return _ChFiDS.ostream_tellp(self)

    def seekp(self, *args):
        return _ChFiDS.ostream_seekp(self, *args)

# Register ostream in _ChFiDS:
_ChFiDS.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _ChFiDS.istream_swiginit(self, _ChFiDS.new_istream(__sb))
    __swig_destroy__ = _ChFiDS.delete_istream

    def __rshift__(self, *args):
        return _ChFiDS.istream___rshift__(self, *args)

    def gcount(self):
        return _ChFiDS.istream_gcount(self)

    def get(self, *args):
        return _ChFiDS.istream_get(self, *args)

    def getline(self, *args):
        return _ChFiDS.istream_getline(self, *args)

    def ignore(self, *args):
        return _ChFiDS.istream_ignore(self, *args)

    def peek(self):
        return _ChFiDS.istream_peek(self)

    def read(self, __s, __n):
        return _ChFiDS.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _ChFiDS.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _ChFiDS.istream_putback(self, __c)

    def unget(self):
        return _ChFiDS.istream_unget(self)

    def sync(self):
        return _ChFiDS.istream_sync(self)

    def tellg(self):
        return _ChFiDS.istream_tellg(self)

    def seekg(self, *args):
        return _ChFiDS.istream_seekg(self, *args)

# Register istream in _ChFiDS:
_ChFiDS.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _ChFiDS.iostream_swiginit(self, _ChFiDS.new_iostream(__sb))
    __swig_destroy__ = _ChFiDS.delete_iostream

# Register iostream in _ChFiDS:
_ChFiDS.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _ChFiDS.endl_cb_ptr
endl = _ChFiDS.endl
ends_cb_ptr = _ChFiDS.ends_cb_ptr
ends = _ChFiDS.ends
flush_cb_ptr = _ChFiDS.flush_cb_ptr
flush = _ChFiDS.flush
...
class ChFiDS_IndexedDataMapOfVertexListOfStripe(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class ChFiDS_ListOfHElSpine(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class ChFiDS_ListOfStripe(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class ChFiDS_Regularities(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class ChFiDS_SecArray1(object):
    ...
    def begin(self, *args):
        return _ChFiDS.ChFiDS_SecArray1_begin(self, *args)

    def cbegin(self):
        return _ChFiDS.ChFiDS_SecArray1_cbegin(self)

    def end(self, *args):
        return _ChFiDS.ChFiDS_SecArray1_end(self, *args)
    ...
    def Move(self, *args):
        return _ChFiDS.ChFiDS_SecArray1_Move(self, *args)
    ...
    def UpdateLowerBound(self, theLower):
        return _ChFiDS.ChFiDS_SecArray1_UpdateLowerBound(self, theLower)

    def UpdateUpperBound(self, theUpper):
        return _ChFiDS.ChFiDS_SecArray1_UpdateUpperBound(self, theUpper)
...
class ChFiDS_StripeArray1(object):
    ...
    def begin(self, *args):
        return _ChFiDS.ChFiDS_StripeArray1_begin(self, *args)

    def cbegin(self):
        return _ChFiDS.ChFiDS_StripeArray1_cbegin(self)

    def end(self, *args):
        return _ChFiDS.ChFiDS_StripeArray1_end(self, *args)
    ...
    def Move(self, *args):
        return _ChFiDS.ChFiDS_StripeArray1_Move(self, *args)
    ...
    def UpdateLowerBound(self, theLower):
        return _ChFiDS.ChFiDS_StripeArray1_UpdateLowerBound(self, theLower)

    def UpdateUpperBound(self, theUpper):
        return _ChFiDS.ChFiDS_StripeArray1_UpdateUpperBound(self, theUpper)
