...
process_exception = _Hermit.process_exception
...
class hermit(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, hermit, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, hermit, name)
    __repr__ = _swig_repr
