...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _Sweep.ios_base_erase_event
    imbue_event = _Sweep.ios_base_imbue_event
    copyfmt_event = _Sweep.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _Sweep.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _Sweep.ios_base_flags(self, *args)

    def setf(self, *args):
        return _Sweep.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _Sweep.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _Sweep.ios_base_precision(self, *args)

    def width(self, *args):
        return _Sweep.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _Sweep.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _Sweep.ios_base_imbue(self, __loc)

    def getloc(self):
        return _Sweep.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _Sweep.ios_base_xalloc()

    def iword(self, __ix):
        return _Sweep.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _Sweep.ios_base_pword(self, __ix)
    __swig_destroy__ = _Sweep.delete_ios_base

# Register ios_base in _Sweep:
_Sweep.ios_base_swigregister(ios_base)
cvar = _Sweep.cvar
ios_base.boolalpha = _Sweep.cvar.ios_base_boolalpha
ios_base.dec = _Sweep.cvar.ios_base_dec
ios_base.fixed = _Sweep.cvar.ios_base_fixed
ios_base.hex = _Sweep.cvar.ios_base_hex
ios_base.internal = _Sweep.cvar.ios_base_internal
ios_base.left = _Sweep.cvar.ios_base_left
ios_base.oct = _Sweep.cvar.ios_base_oct
ios_base.right = _Sweep.cvar.ios_base_right
ios_base.scientific = _Sweep.cvar.ios_base_scientific
ios_base.showbase = _Sweep.cvar.ios_base_showbase
ios_base.showpoint = _Sweep.cvar.ios_base_showpoint
ios_base.showpos = _Sweep.cvar.ios_base_showpos
ios_base.skipws = _Sweep.cvar.ios_base_skipws
ios_base.unitbuf = _Sweep.cvar.ios_base_unitbuf
ios_base.uppercase = _Sweep.cvar.ios_base_uppercase
ios_base.adjustfield = _Sweep.cvar.ios_base_adjustfield
ios_base.basefield = _Sweep.cvar.ios_base_basefield
ios_base.floatfield = _Sweep.cvar.ios_base_floatfield
ios_base.badbit = _Sweep.cvar.ios_base_badbit
ios_base.eofbit = _Sweep.cvar.ios_base_eofbit
ios_base.failbit = _Sweep.cvar.ios_base_failbit
ios_base.goodbit = _Sweep.cvar.ios_base_goodbit
ios_base.app = _Sweep.cvar.ios_base_app
ios_base.ate = _Sweep.cvar.ios_base_ate
ios_base.binary = _Sweep.cvar.ios_base_binary
ios_base.ios_base_in = _Sweep.cvar.ios_base_ios_base_in
ios_base.out = _Sweep.cvar.ios_base_out
ios_base.trunc = _Sweep.cvar.ios_base_trunc
ios_base.beg = _Sweep.cvar.ios_base_beg
ios_base.cur = _Sweep.cvar.ios_base_cur
ios_base.end = _Sweep.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _Sweep.ios_rdstate(self)

    def clear(self, *args):
        return _Sweep.ios_clear(self, *args)

    def setstate(self, __state):
        return _Sweep.ios_setstate(self, __state)

    def good(self):
        return _Sweep.ios_good(self)

    def eof(self):
        return _Sweep.ios_eof(self)

    def fail(self):
        return _Sweep.ios_fail(self)

    def bad(self):
        return _Sweep.ios_bad(self)

    def exceptions(self, *args):
        return _Sweep.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _Sweep.ios_swiginit(self, _Sweep.new_ios(__sb))
    __swig_destroy__ = _Sweep.delete_ios

    def tie(self, *args):
        return _Sweep.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _Sweep.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _Sweep.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _Sweep.ios_fill(self, *args)

    def imbue(self, __loc):
        return _Sweep.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _Sweep.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _Sweep.ios_widen(self, __c)

# Register ios in _Sweep:
_Sweep.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Sweep.ostream_swiginit(self, _Sweep.new_ostream(__sb))
    __swig_destroy__ = _Sweep.delete_ostream

    def __lshift__(self, *args):
        return _Sweep.ostream___lshift__(self, *args)

    def put(self, __c):
        return _Sweep.ostream_put(self, __c)

    def write(self, __s, __n):
        return _Sweep.ostream_write(self, __s, __n)

    def flush(self):
        return _Sweep.ostream_flush(self)

    def tellp(self):
        return _Sweep.ostream_tellp(self)

    def seekp(self, *args):
        return _Sweep.ostream_seekp(self, *args)

# Register ostream in _Sweep:
_Sweep.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Sweep.istream_swiginit(self, _Sweep.new_istream(__sb))
    __swig_destroy__ = _Sweep.delete_istream

    def __rshift__(self, *args):
        return _Sweep.istream___rshift__(self, *args)

    def gcount(self):
        return _Sweep.istream_gcount(self)

    def get(self, *args):
        return _Sweep.istream_get(self, *args)

    def getline(self, *args):
        return _Sweep.istream_getline(self, *args)

    def ignore(self, *args):
        return _Sweep.istream_ignore(self, *args)

    def peek(self):
        return _Sweep.istream_peek(self)

    def read(self, __s, __n):
        return _Sweep.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _Sweep.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _Sweep.istream_putback(self, __c)

    def unget(self):
        return _Sweep.istream_unget(self)

    def sync(self):
        return _Sweep.istream_sync(self)

    def tellg(self):
        return _Sweep.istream_tellg(self)

    def seekg(self, *args):
        return _Sweep.istream_seekg(self, *args)

# Register istream in _Sweep:
_Sweep.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Sweep.iostream_swiginit(self, _Sweep.new_iostream(__sb))
    __swig_destroy__ = _Sweep.delete_iostream

# Register iostream in _Sweep:
_Sweep.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _Sweep.endl_cb_ptr
endl = _Sweep.endl
ends_cb_ptr = _Sweep.ends_cb_ptr
ends = _Sweep.ends
flush_cb_ptr = _Sweep.flush_cb_ptr
flush = _Sweep.flush
