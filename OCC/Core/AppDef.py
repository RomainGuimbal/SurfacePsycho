...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_appdef.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _AppDef.ios_base_erase_event
    imbue_event = _AppDef.ios_base_imbue_event
    copyfmt_event = _AppDef.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _AppDef.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _AppDef.ios_base_flags(self, *args)

    def setf(self, *args):
        return _AppDef.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _AppDef.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _AppDef.ios_base_precision(self, *args)

    def width(self, *args):
        return _AppDef.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _AppDef.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _AppDef.ios_base_imbue(self, __loc)

    def getloc(self):
        return _AppDef.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _AppDef.ios_base_xalloc()

    def iword(self, __ix):
        return _AppDef.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _AppDef.ios_base_pword(self, __ix)
    __swig_destroy__ = _AppDef.delete_ios_base

# Register ios_base in _AppDef:
_AppDef.ios_base_swigregister(ios_base)
cvar = _AppDef.cvar
ios_base.boolalpha = _AppDef.cvar.ios_base_boolalpha
ios_base.dec = _AppDef.cvar.ios_base_dec
ios_base.fixed = _AppDef.cvar.ios_base_fixed
ios_base.hex = _AppDef.cvar.ios_base_hex
ios_base.internal = _AppDef.cvar.ios_base_internal
ios_base.left = _AppDef.cvar.ios_base_left
ios_base.oct = _AppDef.cvar.ios_base_oct
ios_base.right = _AppDef.cvar.ios_base_right
ios_base.scientific = _AppDef.cvar.ios_base_scientific
ios_base.showbase = _AppDef.cvar.ios_base_showbase
ios_base.showpoint = _AppDef.cvar.ios_base_showpoint
ios_base.showpos = _AppDef.cvar.ios_base_showpos
ios_base.skipws = _AppDef.cvar.ios_base_skipws
ios_base.unitbuf = _AppDef.cvar.ios_base_unitbuf
ios_base.uppercase = _AppDef.cvar.ios_base_uppercase
ios_base.adjustfield = _AppDef.cvar.ios_base_adjustfield
ios_base.basefield = _AppDef.cvar.ios_base_basefield
ios_base.floatfield = _AppDef.cvar.ios_base_floatfield
ios_base.badbit = _AppDef.cvar.ios_base_badbit
ios_base.eofbit = _AppDef.cvar.ios_base_eofbit
ios_base.failbit = _AppDef.cvar.ios_base_failbit
ios_base.goodbit = _AppDef.cvar.ios_base_goodbit
ios_base.app = _AppDef.cvar.ios_base_app
ios_base.ate = _AppDef.cvar.ios_base_ate
ios_base.binary = _AppDef.cvar.ios_base_binary
ios_base.ios_base_in = _AppDef.cvar.ios_base_ios_base_in
ios_base.out = _AppDef.cvar.ios_base_out
ios_base.trunc = _AppDef.cvar.ios_base_trunc
ios_base.beg = _AppDef.cvar.ios_base_beg
ios_base.cur = _AppDef.cvar.ios_base_cur
ios_base.end = _AppDef.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _AppDef.ios_rdstate(self)

    def clear(self, *args):
        return _AppDef.ios_clear(self, *args)

    def setstate(self, __state):
        return _AppDef.ios_setstate(self, __state)

    def good(self):
        return _AppDef.ios_good(self)

    def eof(self):
        return _AppDef.ios_eof(self)

    def fail(self):
        return _AppDef.ios_fail(self)

    def bad(self):
        return _AppDef.ios_bad(self)

    def exceptions(self, *args):
        return _AppDef.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _AppDef.ios_swiginit(self, _AppDef.new_ios(__sb))
    __swig_destroy__ = _AppDef.delete_ios

    def tie(self, *args):
        return _AppDef.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _AppDef.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _AppDef.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _AppDef.ios_fill(self, *args)

    def imbue(self, __loc):
        return _AppDef.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _AppDef.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _AppDef.ios_widen(self, __c)

# Register ios in _AppDef:
_AppDef.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _AppDef.ostream_swiginit(self, _AppDef.new_ostream(__sb))
    __swig_destroy__ = _AppDef.delete_ostream

    def __lshift__(self, *args):
        return _AppDef.ostream___lshift__(self, *args)

    def put(self, __c):
        return _AppDef.ostream_put(self, __c)

    def write(self, __s, __n):
        return _AppDef.ostream_write(self, __s, __n)

    def flush(self):
        return _AppDef.ostream_flush(self)

    def tellp(self):
        return _AppDef.ostream_tellp(self)

    def seekp(self, *args):
        return _AppDef.ostream_seekp(self, *args)

# Register ostream in _AppDef:
_AppDef.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _AppDef.istream_swiginit(self, _AppDef.new_istream(__sb))
    __swig_destroy__ = _AppDef.delete_istream

    def __rshift__(self, *args):
        return _AppDef.istream___rshift__(self, *args)

    def gcount(self):
        return _AppDef.istream_gcount(self)

    def get(self, *args):
        return _AppDef.istream_get(self, *args)

    def getline(self, *args):
        return _AppDef.istream_getline(self, *args)

    def ignore(self, *args):
        return _AppDef.istream_ignore(self, *args)

    def peek(self):
        return _AppDef.istream_peek(self)

    def read(self, __s, __n):
        return _AppDef.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _AppDef.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _AppDef.istream_putback(self, __c)

    def unget(self):
        return _AppDef.istream_unget(self)

    def sync(self):
        return _AppDef.istream_sync(self)

    def tellg(self):
        return _AppDef.istream_tellg(self)

    def seekg(self, *args):
        return _AppDef.istream_seekg(self, *args)

# Register istream in _AppDef:
_AppDef.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _AppDef.iostream_swiginit(self, _AppDef.new_iostream(__sb))
    __swig_destroy__ = _AppDef.delete_iostream

# Register iostream in _AppDef:
_AppDef.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _AppDef.endl_cb_ptr
endl = _AppDef.endl
ends_cb_ptr = _AppDef.ends_cb_ptr
ends = _AppDef.ends
flush_cb_ptr = _AppDef.flush_cb_ptr
flush = _AppDef.flush
...
class AppDef_Array1OfMultiPointConstraint(object):
    ...
    def begin(self, *args):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_begin(self, *args)

    def cbegin(self):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_cbegin(self)

    def end(self, *args):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_end(self, *args)
    ...
    def Move(self, *args):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_Move(self, *args)
    ...
    def SetValue(self, *args):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_SetValue(self, *args)

    def UpdateLowerBound(self, theLower):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_UpdateLowerBound(self, theLower)

    def UpdateUpperBound(self, theUpper):
        return _AppDef.AppDef_Array1OfMultiPointConstraint_UpdateUpperBound(self, theUpper)
