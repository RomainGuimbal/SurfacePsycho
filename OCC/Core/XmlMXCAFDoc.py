...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_xmlmxcafdoc.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _XmlMXCAFDoc.ios_base_erase_event
    imbue_event = _XmlMXCAFDoc.ios_base_imbue_event
    copyfmt_event = _XmlMXCAFDoc.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _XmlMXCAFDoc.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _XmlMXCAFDoc.ios_base_flags(self, *args)

    def setf(self, *args):
        return _XmlMXCAFDoc.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _XmlMXCAFDoc.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _XmlMXCAFDoc.ios_base_precision(self, *args)

    def width(self, *args):
        return _XmlMXCAFDoc.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _XmlMXCAFDoc.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _XmlMXCAFDoc.ios_base_imbue(self, __loc)

    def getloc(self):
        return _XmlMXCAFDoc.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _XmlMXCAFDoc.ios_base_xalloc()

    def iword(self, __ix):
        return _XmlMXCAFDoc.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _XmlMXCAFDoc.ios_base_pword(self, __ix)
    __swig_destroy__ = _XmlMXCAFDoc.delete_ios_base

# Register ios_base in _XmlMXCAFDoc:
_XmlMXCAFDoc.ios_base_swigregister(ios_base)
cvar = _XmlMXCAFDoc.cvar
ios_base.boolalpha = _XmlMXCAFDoc.cvar.ios_base_boolalpha
ios_base.dec = _XmlMXCAFDoc.cvar.ios_base_dec
ios_base.fixed = _XmlMXCAFDoc.cvar.ios_base_fixed
ios_base.hex = _XmlMXCAFDoc.cvar.ios_base_hex
ios_base.internal = _XmlMXCAFDoc.cvar.ios_base_internal
ios_base.left = _XmlMXCAFDoc.cvar.ios_base_left
ios_base.oct = _XmlMXCAFDoc.cvar.ios_base_oct
ios_base.right = _XmlMXCAFDoc.cvar.ios_base_right
ios_base.scientific = _XmlMXCAFDoc.cvar.ios_base_scientific
ios_base.showbase = _XmlMXCAFDoc.cvar.ios_base_showbase
ios_base.showpoint = _XmlMXCAFDoc.cvar.ios_base_showpoint
ios_base.showpos = _XmlMXCAFDoc.cvar.ios_base_showpos
ios_base.skipws = _XmlMXCAFDoc.cvar.ios_base_skipws
ios_base.unitbuf = _XmlMXCAFDoc.cvar.ios_base_unitbuf
ios_base.uppercase = _XmlMXCAFDoc.cvar.ios_base_uppercase
ios_base.adjustfield = _XmlMXCAFDoc.cvar.ios_base_adjustfield
ios_base.basefield = _XmlMXCAFDoc.cvar.ios_base_basefield
ios_base.floatfield = _XmlMXCAFDoc.cvar.ios_base_floatfield
ios_base.badbit = _XmlMXCAFDoc.cvar.ios_base_badbit
ios_base.eofbit = _XmlMXCAFDoc.cvar.ios_base_eofbit
ios_base.failbit = _XmlMXCAFDoc.cvar.ios_base_failbit
ios_base.goodbit = _XmlMXCAFDoc.cvar.ios_base_goodbit
ios_base.app = _XmlMXCAFDoc.cvar.ios_base_app
ios_base.ate = _XmlMXCAFDoc.cvar.ios_base_ate
ios_base.binary = _XmlMXCAFDoc.cvar.ios_base_binary
ios_base.ios_base_in = _XmlMXCAFDoc.cvar.ios_base_ios_base_in
ios_base.out = _XmlMXCAFDoc.cvar.ios_base_out
ios_base.trunc = _XmlMXCAFDoc.cvar.ios_base_trunc
ios_base.beg = _XmlMXCAFDoc.cvar.ios_base_beg
ios_base.cur = _XmlMXCAFDoc.cvar.ios_base_cur
ios_base.end = _XmlMXCAFDoc.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _XmlMXCAFDoc.ios_rdstate(self)

    def clear(self, *args):
        return _XmlMXCAFDoc.ios_clear(self, *args)

    def setstate(self, __state):
        return _XmlMXCAFDoc.ios_setstate(self, __state)

    def good(self):
        return _XmlMXCAFDoc.ios_good(self)

    def eof(self):
        return _XmlMXCAFDoc.ios_eof(self)

    def fail(self):
        return _XmlMXCAFDoc.ios_fail(self)

    def bad(self):
        return _XmlMXCAFDoc.ios_bad(self)

    def exceptions(self, *args):
        return _XmlMXCAFDoc.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _XmlMXCAFDoc.ios_swiginit(self, _XmlMXCAFDoc.new_ios(__sb))
    __swig_destroy__ = _XmlMXCAFDoc.delete_ios

    def tie(self, *args):
        return _XmlMXCAFDoc.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _XmlMXCAFDoc.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _XmlMXCAFDoc.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _XmlMXCAFDoc.ios_fill(self, *args)

    def imbue(self, __loc):
        return _XmlMXCAFDoc.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _XmlMXCAFDoc.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _XmlMXCAFDoc.ios_widen(self, __c)

# Register ios in _XmlMXCAFDoc:
_XmlMXCAFDoc.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _XmlMXCAFDoc.ostream_swiginit(self, _XmlMXCAFDoc.new_ostream(__sb))
    __swig_destroy__ = _XmlMXCAFDoc.delete_ostream

    def __lshift__(self, *args):
        return _XmlMXCAFDoc.ostream___lshift__(self, *args)

    def put(self, __c):
        return _XmlMXCAFDoc.ostream_put(self, __c)

    def write(self, __s, __n):
        return _XmlMXCAFDoc.ostream_write(self, __s, __n)

    def flush(self):
        return _XmlMXCAFDoc.ostream_flush(self)

    def tellp(self):
        return _XmlMXCAFDoc.ostream_tellp(self)

    def seekp(self, *args):
        return _XmlMXCAFDoc.ostream_seekp(self, *args)

# Register ostream in _XmlMXCAFDoc:
_XmlMXCAFDoc.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _XmlMXCAFDoc.istream_swiginit(self, _XmlMXCAFDoc.new_istream(__sb))
    __swig_destroy__ = _XmlMXCAFDoc.delete_istream

    def __rshift__(self, *args):
        return _XmlMXCAFDoc.istream___rshift__(self, *args)

    def gcount(self):
        return _XmlMXCAFDoc.istream_gcount(self)

    def get(self, *args):
        return _XmlMXCAFDoc.istream_get(self, *args)

    def getline(self, *args):
        return _XmlMXCAFDoc.istream_getline(self, *args)

    def ignore(self, *args):
        return _XmlMXCAFDoc.istream_ignore(self, *args)

    def peek(self):
        return _XmlMXCAFDoc.istream_peek(self)

    def read(self, __s, __n):
        return _XmlMXCAFDoc.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _XmlMXCAFDoc.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _XmlMXCAFDoc.istream_putback(self, __c)

    def unget(self):
        return _XmlMXCAFDoc.istream_unget(self)

    def sync(self):
        return _XmlMXCAFDoc.istream_sync(self)

    def tellg(self):
        return _XmlMXCAFDoc.istream_tellg(self)

    def seekg(self, *args):
        return _XmlMXCAFDoc.istream_seekg(self, *args)

# Register istream in _XmlMXCAFDoc:
_XmlMXCAFDoc.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _XmlMXCAFDoc.iostream_swiginit(self, _XmlMXCAFDoc.new_iostream(__sb))
    __swig_destroy__ = _XmlMXCAFDoc.delete_iostream

# Register iostream in _XmlMXCAFDoc:
_XmlMXCAFDoc.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _XmlMXCAFDoc.endl_cb_ptr
endl = _XmlMXCAFDoc.endl
ends_cb_ptr = _XmlMXCAFDoc.ends_cb_ptr
ends = _XmlMXCAFDoc.ends
flush_cb_ptr = _XmlMXCAFDoc.flush_cb_ptr
flush = _XmlMXCAFDoc.flush
