...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_stepdata.html
"""
...
class StepData_ConfParameters(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    AngleUnitMode_File = _StepData.StepData_ConfParameters_AngleUnitMode_File
    AngleUnitMode_Rad = _StepData.StepData_ConfParameters_AngleUnitMode_Rad
    AngleUnitMode_Deg = _StepData.StepData_ConfParameters_AngleUnitMode_Deg
    RWMode_Tessellated_Off = _StepData.StepData_ConfParameters_RWMode_Tessellated_Off
    RWMode_Tessellated_On = _StepData.StepData_ConfParameters_RWMode_Tessellated_On
    RWMode_Tessellated_OnNoBRep = _StepData.StepData_ConfParameters_RWMode_Tessellated_OnNoBRep
    ReadMode_AssemblyLevel_All = _StepData.StepData_ConfParameters_ReadMode_AssemblyLevel_All
    ReadMode_AssemblyLevel_Assembly = _StepData.StepData_ConfParameters_ReadMode_AssemblyLevel_Assembly
    ReadMode_AssemblyLevel_Structure = _StepData.StepData_ConfParameters_ReadMode_AssemblyLevel_Structure
    ReadMode_AssemblyLevel_Shape = _StepData.StepData_ConfParameters_ReadMode_AssemblyLevel_Shape
    ReadMode_BSplineContinuity_C0 = _StepData.StepData_ConfParameters_ReadMode_BSplineContinuity_C0
    ReadMode_BSplineContinuity_C1 = _StepData.StepData_ConfParameters_ReadMode_BSplineContinuity_C1
    ReadMode_BSplineContinuity_C2 = _StepData.StepData_ConfParameters_ReadMode_BSplineContinuity_C2
    ReadMode_MaxPrecision_Preferred = _StepData.StepData_ConfParameters_ReadMode_MaxPrecision_Preferred
    ReadMode_MaxPrecision_Forced = _StepData.StepData_ConfParameters_ReadMode_MaxPrecision_Forced
    ReadMode_Precision_File = _StepData.StepData_ConfParameters_ReadMode_Precision_File
    ReadMode_Precision_User = _StepData.StepData_ConfParameters_ReadMode_Precision_User
    ReadMode_ProductContext_All = _StepData.StepData_ConfParameters_ReadMode_ProductContext_All
    ReadMode_ProductContext_Design = _StepData.StepData_ConfParameters_ReadMode_ProductContext_Design
    ReadMode_ProductContext_Analysis = _StepData.StepData_ConfParameters_ReadMode_ProductContext_Analysis
    ReadMode_ShapeRepr_All = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_All
    ReadMode_ShapeRepr_ABSR = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_ABSR
    ReadMode_ShapeRepr_MSSR = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_MSSR
    ReadMode_ShapeRepr_GBSSR = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_GBSSR
    ReadMode_ShapeRepr_FBSR = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_FBSR
    ReadMode_ShapeRepr_EBWSR = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_EBWSR
    ReadMode_ShapeRepr_GBWSR = _StepData.StepData_ConfParameters_ReadMode_ShapeRepr_GBWSR
    ReadMode_SurfaceCurve_Default = _StepData.StepData_ConfParameters_ReadMode_SurfaceCurve_Default
    ReadMode_SurfaceCurve_2DUse_Preferred = _StepData.StepData_ConfParameters_ReadMode_SurfaceCurve_2DUse_Preferred
    ReadMode_SurfaceCurve_2DUse_Forced = _StepData.StepData_ConfParameters_ReadMode_SurfaceCurve_2DUse_Forced
    ReadMode_SurfaceCurve_3DUse_Preferred = _StepData.StepData_ConfParameters_ReadMode_SurfaceCurve_3DUse_Preferred
    ReadMode_SurfaceCurve_3DUse_Forced = _StepData.StepData_ConfParameters_ReadMode_SurfaceCurve_3DUse_Forced
    WriteMode_Assembly_Off = _StepData.StepData_ConfParameters_WriteMode_Assembly_Off
    WriteMode_Assembly_On = _StepData.StepData_ConfParameters_WriteMode_Assembly_On
    WriteMode_Assembly_Auto = _StepData.StepData_ConfParameters_WriteMode_Assembly_Auto
    WriteMode_PrecisionMode_Least = _StepData.StepData_ConfParameters_WriteMode_PrecisionMode_Least
    WriteMode_PrecisionMode_Average = _StepData.StepData_ConfParameters_WriteMode_PrecisionMode_Average
    WriteMode_PrecisionMode_Greatest = _StepData.StepData_ConfParameters_WriteMode_PrecisionMode_Greatest
    WriteMode_PrecisionMode_Session = _StepData.StepData_ConfParameters_WriteMode_PrecisionMode_Session
    WriteMode_StepSchema_AP214CD = _StepData.StepData_ConfParameters_WriteMode_StepSchema_AP214CD
    WriteMode_StepSchema_AP214DIS = _StepData.StepData_ConfParameters_WriteMode_StepSchema_AP214DIS
    WriteMode_StepSchema_AP203 = _StepData.StepData_ConfParameters_WriteMode_StepSchema_AP203
    WriteMode_StepSchema_AP214IS = _StepData.StepData_ConfParameters_WriteMode_StepSchema_AP214IS
    WriteMode_StepSchema_AP242DIS = _StepData.StepData_ConfParameters_WriteMode_StepSchema_AP242DIS
    WriteMode_VertexMode_OneCompound = _StepData.StepData_ConfParameters_WriteMode_VertexMode_OneCompound
    WriteMode_VertexMode_SingleVertex = _StepData.StepData_ConfParameters_WriteMode_VertexMode_SingleVertex
    ...
    ReadBSplineContinuity = property(_StepData.StepData_ConfParameters_ReadBSplineContinuity_get, _StepData.StepData_ConfParameters_ReadBSplineContinuity_set)
    ReadPrecisionMode = property(_StepData.StepData_ConfParameters_ReadPrecisionMode_get, _StepData.StepData_ConfParameters_ReadPrecisionMode_set)
    ReadPrecisionVal = property(_StepData.StepData_ConfParameters_ReadPrecisionVal_get, _StepData.StepData_ConfParameters_ReadPrecisionVal_set)
    ReadMaxPrecisionMode = property(_StepData.StepData_ConfParameters_ReadMaxPrecisionMode_get, _StepData.StepData_ConfParameters_ReadMaxPrecisionMode_set)
    ReadMaxPrecisionVal = property(_StepData.StepData_ConfParameters_ReadMaxPrecisionVal_get, _StepData.StepData_ConfParameters_ReadMaxPrecisionVal_set)
    ReadSameParamMode = property(_StepData.StepData_ConfParameters_ReadSameParamMode_get, _StepData.StepData_ConfParameters_ReadSameParamMode_set)
    ReadSurfaceCurveMode = property(_StepData.StepData_ConfParameters_ReadSurfaceCurveMode_get, _StepData.StepData_ConfParameters_ReadSurfaceCurveMode_set)
    EncodeRegAngle = property(_StepData.StepData_ConfParameters_EncodeRegAngle_get, _StepData.StepData_ConfParameters_EncodeRegAngle_set)
    AngleUnit = property(_StepData.StepData_ConfParameters_AngleUnit_get, _StepData.StepData_ConfParameters_AngleUnit_set)
    ReadResourceName = property(_StepData.StepData_ConfParameters_ReadResourceName_get, _StepData.StepData_ConfParameters_ReadResourceName_set)
    ReadSequence = property(_StepData.StepData_ConfParameters_ReadSequence_get, _StepData.StepData_ConfParameters_ReadSequence_set)
    ReadProductMode = property(_StepData.StepData_ConfParameters_ReadProductMode_get, _StepData.StepData_ConfParameters_ReadProductMode_set)
    ReadProductContext = property(_StepData.StepData_ConfParameters_ReadProductContext_get, _StepData.StepData_ConfParameters_ReadProductContext_set)
    ReadShapeRepr = property(_StepData.StepData_ConfParameters_ReadShapeRepr_get, _StepData.StepData_ConfParameters_ReadShapeRepr_set)
    ReadTessellated = property(_StepData.StepData_ConfParameters_ReadTessellated_get, _StepData.StepData_ConfParameters_ReadTessellated_set)
    ReadAssemblyLevel = property(_StepData.StepData_ConfParameters_ReadAssemblyLevel_get, _StepData.StepData_ConfParameters_ReadAssemblyLevel_set)
    ReadRelationship = property(_StepData.StepData_ConfParameters_ReadRelationship_get, _StepData.StepData_ConfParameters_ReadRelationship_set)
    ReadShapeAspect = property(_StepData.StepData_ConfParameters_ReadShapeAspect_get, _StepData.StepData_ConfParameters_ReadShapeAspect_set)
    ReadConstrRelation = property(_StepData.StepData_ConfParameters_ReadConstrRelation_get, _StepData.StepData_ConfParameters_ReadConstrRelation_set)
    ReadSubshapeNames = property(_StepData.StepData_ConfParameters_ReadSubshapeNames_get, _StepData.StepData_ConfParameters_ReadSubshapeNames_set)
    ReadCodePage = property(_StepData.StepData_ConfParameters_ReadCodePage_get, _StepData.StepData_ConfParameters_ReadCodePage_set)
    ReadNonmanifold = property(_StepData.StepData_ConfParameters_ReadNonmanifold_get, _StepData.StepData_ConfParameters_ReadNonmanifold_set)
    ReadIdeas = property(_StepData.StepData_ConfParameters_ReadIdeas_get, _StepData.StepData_ConfParameters_ReadIdeas_set)
    ReadAllShapes = property(_StepData.StepData_ConfParameters_ReadAllShapes_get, _StepData.StepData_ConfParameters_ReadAllShapes_set)
    ReadRootTransformation = property(_StepData.StepData_ConfParameters_ReadRootTransformation_get, _StepData.StepData_ConfParameters_ReadRootTransformation_set)
    ReadColor = property(_StepData.StepData_ConfParameters_ReadColor_get, _StepData.StepData_ConfParameters_ReadColor_set)
    ReadName = property(_StepData.StepData_ConfParameters_ReadName_get, _StepData.StepData_ConfParameters_ReadName_set)
    ReadLayer = property(_StepData.StepData_ConfParameters_ReadLayer_get, _StepData.StepData_ConfParameters_ReadLayer_set)
    ReadProps = property(_StepData.StepData_ConfParameters_ReadProps_get, _StepData.StepData_ConfParameters_ReadProps_set)
    WritePrecisionMode = property(_StepData.StepData_ConfParameters_WritePrecisionMode_get, _StepData.StepData_ConfParameters_WritePrecisionMode_set)
    WritePrecisionVal = property(_StepData.StepData_ConfParameters_WritePrecisionVal_get, _StepData.StepData_ConfParameters_WritePrecisionVal_set)
    WriteAssembly = property(_StepData.StepData_ConfParameters_WriteAssembly_get, _StepData.StepData_ConfParameters_WriteAssembly_set)
    WriteSchema = property(_StepData.StepData_ConfParameters_WriteSchema_get, _StepData.StepData_ConfParameters_WriteSchema_set)
    WriteTessellated = property(_StepData.StepData_ConfParameters_WriteTessellated_get, _StepData.StepData_ConfParameters_WriteTessellated_set)
    WriteProductName = property(_StepData.StepData_ConfParameters_WriteProductName_get, _StepData.StepData_ConfParameters_WriteProductName_set)
    WriteSurfaceCurMode = property(_StepData.StepData_ConfParameters_WriteSurfaceCurMode_get, _StepData.StepData_ConfParameters_WriteSurfaceCurMode_set)
    WriteUnit = property(_StepData.StepData_ConfParameters_WriteUnit_get, _StepData.StepData_ConfParameters_WriteUnit_set)
    WriteResourceName = property(_StepData.StepData_ConfParameters_WriteResourceName_get, _StepData.StepData_ConfParameters_WriteResourceName_set)
    WriteSequence = property(_StepData.StepData_ConfParameters_WriteSequence_get, _StepData.StepData_ConfParameters_WriteSequence_set)
    WriteVertexMode = property(_StepData.StepData_ConfParameters_WriteVertexMode_get, _StepData.StepData_ConfParameters_WriteVertexMode_set)
    WriteSubshapeNames = property(_StepData.StepData_ConfParameters_WriteSubshapeNames_get, _StepData.StepData_ConfParameters_WriteSubshapeNames_set)
    WriteColor = property(_StepData.StepData_ConfParameters_WriteColor_get, _StepData.StepData_ConfParameters_WriteColor_set)
    WriteNonmanifold = property(_StepData.StepData_ConfParameters_WriteNonmanifold_get, _StepData.StepData_ConfParameters_WriteNonmanifold_set)
    WriteName = property(_StepData.StepData_ConfParameters_WriteName_get, _StepData.StepData_ConfParameters_WriteName_set)
    WriteLayer = property(_StepData.StepData_ConfParameters_WriteLayer_get, _StepData.StepData_ConfParameters_WriteLayer_set)
    WriteProps = property(_StepData.StepData_ConfParameters_WriteProps_get, _StepData.StepData_ConfParameters_WriteProps_set)
    WriteModelType = property(_StepData.StepData_ConfParameters_WriteModelType_get, _StepData.StepData_ConfParameters_WriteModelType_set)
    ...
    def __init__(self, *args):
        ...
        """
        _StepData.StepData_ConfParameters_swiginit(self, _StepData.new_StepData_ConfParameters(*args))
    ...
    def GetString(self, *args):
        ...
        """
        return _StepData.StepData_ConfParameters_GetString(self, *args)

    def InitFromStatic(self, *args):
        r"""
        Return
        -------
        None
        ...
        """
        return _StepData.StepData_ConfParameters_InitFromStatic(self, *args)
    ...
    def Reset(self, *args):
        ...
        """
        return _StepData.StepData_ConfParameters_Reset(self, *args)

    __repr__ = _dumps_object

    __swig_destroy__ = _StepData.delete_StepData_ConfParameters

# Register StepData_ConfParameters in _StepData:
_StepData.StepData_ConfParameters_swigregister(StepData_ConfParameters)
...
class StepData_StepModel(OCC.Core.Interface.Interface_InterfaceModel):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    InternalParameters = property(_StepData.StepData_StepModel_InternalParameters_get, _StepData.StepData_StepModel_InternalParameters_set, doc=r"""InternalParameters : StepData_ConfParameters""")
