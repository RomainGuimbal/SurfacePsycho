...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_prsdim.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _PrsDim.ios_base_erase_event
    imbue_event = _PrsDim.ios_base_imbue_event
    copyfmt_event = _PrsDim.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _PrsDim.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _PrsDim.ios_base_flags(self, *args)

    def setf(self, *args):
        return _PrsDim.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _PrsDim.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _PrsDim.ios_base_precision(self, *args)

    def width(self, *args):
        return _PrsDim.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _PrsDim.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _PrsDim.ios_base_imbue(self, __loc)

    def getloc(self):
        return _PrsDim.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _PrsDim.ios_base_xalloc()

    def iword(self, __ix):
        return _PrsDim.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _PrsDim.ios_base_pword(self, __ix)
    __swig_destroy__ = _PrsDim.delete_ios_base

# Register ios_base in _PrsDim:
_PrsDim.ios_base_swigregister(ios_base)
cvar = _PrsDim.cvar
ios_base.boolalpha = _PrsDim.cvar.ios_base_boolalpha
ios_base.dec = _PrsDim.cvar.ios_base_dec
ios_base.fixed = _PrsDim.cvar.ios_base_fixed
ios_base.hex = _PrsDim.cvar.ios_base_hex
ios_base.internal = _PrsDim.cvar.ios_base_internal
ios_base.left = _PrsDim.cvar.ios_base_left
ios_base.oct = _PrsDim.cvar.ios_base_oct
ios_base.right = _PrsDim.cvar.ios_base_right
ios_base.scientific = _PrsDim.cvar.ios_base_scientific
ios_base.showbase = _PrsDim.cvar.ios_base_showbase
ios_base.showpoint = _PrsDim.cvar.ios_base_showpoint
ios_base.showpos = _PrsDim.cvar.ios_base_showpos
ios_base.skipws = _PrsDim.cvar.ios_base_skipws
ios_base.unitbuf = _PrsDim.cvar.ios_base_unitbuf
ios_base.uppercase = _PrsDim.cvar.ios_base_uppercase
ios_base.adjustfield = _PrsDim.cvar.ios_base_adjustfield
ios_base.basefield = _PrsDim.cvar.ios_base_basefield
ios_base.floatfield = _PrsDim.cvar.ios_base_floatfield
ios_base.badbit = _PrsDim.cvar.ios_base_badbit
ios_base.eofbit = _PrsDim.cvar.ios_base_eofbit
ios_base.failbit = _PrsDim.cvar.ios_base_failbit
ios_base.goodbit = _PrsDim.cvar.ios_base_goodbit
ios_base.app = _PrsDim.cvar.ios_base_app
ios_base.ate = _PrsDim.cvar.ios_base_ate
ios_base.binary = _PrsDim.cvar.ios_base_binary
ios_base.ios_base_in = _PrsDim.cvar.ios_base_ios_base_in
ios_base.out = _PrsDim.cvar.ios_base_out
ios_base.trunc = _PrsDim.cvar.ios_base_trunc
ios_base.beg = _PrsDim.cvar.ios_base_beg
ios_base.cur = _PrsDim.cvar.ios_base_cur
ios_base.end = _PrsDim.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _PrsDim.ios_rdstate(self)

    def clear(self, *args):
        return _PrsDim.ios_clear(self, *args)

    def setstate(self, __state):
        return _PrsDim.ios_setstate(self, __state)

    def good(self):
        return _PrsDim.ios_good(self)

    def eof(self):
        return _PrsDim.ios_eof(self)

    def fail(self):
        return _PrsDim.ios_fail(self)

    def bad(self):
        return _PrsDim.ios_bad(self)

    def exceptions(self, *args):
        return _PrsDim.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _PrsDim.ios_swiginit(self, _PrsDim.new_ios(__sb))
    __swig_destroy__ = _PrsDim.delete_ios

    def tie(self, *args):
        return _PrsDim.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _PrsDim.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _PrsDim.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _PrsDim.ios_fill(self, *args)

    def imbue(self, __loc):
        return _PrsDim.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _PrsDim.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _PrsDim.ios_widen(self, __c)

# Register ios in _PrsDim:
_PrsDim.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _PrsDim.ostream_swiginit(self, _PrsDim.new_ostream(__sb))
    __swig_destroy__ = _PrsDim.delete_ostream

    def __lshift__(self, *args):
        return _PrsDim.ostream___lshift__(self, *args)

    def put(self, __c):
        return _PrsDim.ostream_put(self, __c)

    def write(self, __s, __n):
        return _PrsDim.ostream_write(self, __s, __n)

    def flush(self):
        return _PrsDim.ostream_flush(self)

    def tellp(self):
        return _PrsDim.ostream_tellp(self)

    def seekp(self, *args):
        return _PrsDim.ostream_seekp(self, *args)

# Register ostream in _PrsDim:
_PrsDim.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _PrsDim.istream_swiginit(self, _PrsDim.new_istream(__sb))
    __swig_destroy__ = _PrsDim.delete_istream

    def __rshift__(self, *args):
        return _PrsDim.istream___rshift__(self, *args)

    def gcount(self):
        return _PrsDim.istream_gcount(self)

    def get(self, *args):
        return _PrsDim.istream_get(self, *args)

    def getline(self, *args):
        return _PrsDim.istream_getline(self, *args)

    def ignore(self, *args):
        return _PrsDim.istream_ignore(self, *args)

    def peek(self):
        return _PrsDim.istream_peek(self)

    def read(self, __s, __n):
        return _PrsDim.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _PrsDim.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _PrsDim.istream_putback(self, __c)

    def unget(self):
        return _PrsDim.istream_unget(self)

    def sync(self):
        return _PrsDim.istream_sync(self)

    def tellg(self):
        return _PrsDim.istream_tellg(self)

    def seekg(self, *args):
        return _PrsDim.istream_seekg(self, *args)

# Register istream in _PrsDim:
_PrsDim.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _PrsDim.iostream_swiginit(self, _PrsDim.new_iostream(__sb))
    __swig_destroy__ = _PrsDim.delete_iostream

# Register iostream in _PrsDim:
_PrsDim.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _PrsDim.endl_cb_ptr
endl = _PrsDim.endl
ends_cb_ptr = _PrsDim.ends_cb_ptr
ends = _PrsDim.ends
flush_cb_ptr = _PrsDim.flush_cb_ptr
flush = _PrsDim.flush
