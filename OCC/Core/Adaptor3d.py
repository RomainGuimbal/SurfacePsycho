...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_adaptor3d.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _Adaptor3d.ios_base_erase_event
    imbue_event = _Adaptor3d.ios_base_imbue_event
    copyfmt_event = _Adaptor3d.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _Adaptor3d.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _Adaptor3d.ios_base_flags(self, *args)

    def setf(self, *args):
        return _Adaptor3d.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _Adaptor3d.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _Adaptor3d.ios_base_precision(self, *args)

    def width(self, *args):
        return _Adaptor3d.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _Adaptor3d.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _Adaptor3d.ios_base_imbue(self, __loc)

    def getloc(self):
        return _Adaptor3d.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _Adaptor3d.ios_base_xalloc()

    def iword(self, __ix):
        return _Adaptor3d.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _Adaptor3d.ios_base_pword(self, __ix)
    __swig_destroy__ = _Adaptor3d.delete_ios_base

# Register ios_base in _Adaptor3d:
_Adaptor3d.ios_base_swigregister(ios_base)
cvar = _Adaptor3d.cvar
ios_base.boolalpha = _Adaptor3d.cvar.ios_base_boolalpha
ios_base.dec = _Adaptor3d.cvar.ios_base_dec
ios_base.fixed = _Adaptor3d.cvar.ios_base_fixed
ios_base.hex = _Adaptor3d.cvar.ios_base_hex
ios_base.internal = _Adaptor3d.cvar.ios_base_internal
ios_base.left = _Adaptor3d.cvar.ios_base_left
ios_base.oct = _Adaptor3d.cvar.ios_base_oct
ios_base.right = _Adaptor3d.cvar.ios_base_right
ios_base.scientific = _Adaptor3d.cvar.ios_base_scientific
ios_base.showbase = _Adaptor3d.cvar.ios_base_showbase
ios_base.showpoint = _Adaptor3d.cvar.ios_base_showpoint
ios_base.showpos = _Adaptor3d.cvar.ios_base_showpos
ios_base.skipws = _Adaptor3d.cvar.ios_base_skipws
ios_base.unitbuf = _Adaptor3d.cvar.ios_base_unitbuf
ios_base.uppercase = _Adaptor3d.cvar.ios_base_uppercase
ios_base.adjustfield = _Adaptor3d.cvar.ios_base_adjustfield
ios_base.basefield = _Adaptor3d.cvar.ios_base_basefield
ios_base.floatfield = _Adaptor3d.cvar.ios_base_floatfield
ios_base.badbit = _Adaptor3d.cvar.ios_base_badbit
ios_base.eofbit = _Adaptor3d.cvar.ios_base_eofbit
ios_base.failbit = _Adaptor3d.cvar.ios_base_failbit
ios_base.goodbit = _Adaptor3d.cvar.ios_base_goodbit
ios_base.app = _Adaptor3d.cvar.ios_base_app
ios_base.ate = _Adaptor3d.cvar.ios_base_ate
ios_base.binary = _Adaptor3d.cvar.ios_base_binary
ios_base.ios_base_in = _Adaptor3d.cvar.ios_base_ios_base_in
ios_base.out = _Adaptor3d.cvar.ios_base_out
ios_base.trunc = _Adaptor3d.cvar.ios_base_trunc
ios_base.beg = _Adaptor3d.cvar.ios_base_beg
ios_base.cur = _Adaptor3d.cvar.ios_base_cur
ios_base.end = _Adaptor3d.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _Adaptor3d.ios_rdstate(self)

    def clear(self, *args):
        return _Adaptor3d.ios_clear(self, *args)

    def setstate(self, __state):
        return _Adaptor3d.ios_setstate(self, __state)

    def good(self):
        return _Adaptor3d.ios_good(self)

    def eof(self):
        return _Adaptor3d.ios_eof(self)

    def fail(self):
        return _Adaptor3d.ios_fail(self)

    def bad(self):
        return _Adaptor3d.ios_bad(self)

    def exceptions(self, *args):
        return _Adaptor3d.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _Adaptor3d.ios_swiginit(self, _Adaptor3d.new_ios(__sb))
    __swig_destroy__ = _Adaptor3d.delete_ios

    def tie(self, *args):
        return _Adaptor3d.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _Adaptor3d.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _Adaptor3d.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _Adaptor3d.ios_fill(self, *args)

    def imbue(self, __loc):
        return _Adaptor3d.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _Adaptor3d.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _Adaptor3d.ios_widen(self, __c)

# Register ios in _Adaptor3d:
_Adaptor3d.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Adaptor3d.ostream_swiginit(self, _Adaptor3d.new_ostream(__sb))
    __swig_destroy__ = _Adaptor3d.delete_ostream

    def __lshift__(self, *args):
        return _Adaptor3d.ostream___lshift__(self, *args)

    def put(self, __c):
        return _Adaptor3d.ostream_put(self, __c)

    def write(self, __s, __n):
        return _Adaptor3d.ostream_write(self, __s, __n)

    def flush(self):
        return _Adaptor3d.ostream_flush(self)

    def tellp(self):
        return _Adaptor3d.ostream_tellp(self)

    def seekp(self, *args):
        return _Adaptor3d.ostream_seekp(self, *args)

# Register ostream in _Adaptor3d:
_Adaptor3d.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Adaptor3d.istream_swiginit(self, _Adaptor3d.new_istream(__sb))
    __swig_destroy__ = _Adaptor3d.delete_istream

    def __rshift__(self, *args):
        return _Adaptor3d.istream___rshift__(self, *args)

    def gcount(self):
        return _Adaptor3d.istream_gcount(self)

    def get(self, *args):
        return _Adaptor3d.istream_get(self, *args)

    def getline(self, *args):
        return _Adaptor3d.istream_getline(self, *args)

    def ignore(self, *args):
        return _Adaptor3d.istream_ignore(self, *args)

    def peek(self):
        return _Adaptor3d.istream_peek(self)

    def read(self, __s, __n):
        return _Adaptor3d.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _Adaptor3d.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _Adaptor3d.istream_putback(self, __c)

    def unget(self):
        return _Adaptor3d.istream_unget(self)

    def sync(self):
        return _Adaptor3d.istream_sync(self)

    def tellg(self):
        return _Adaptor3d.istream_tellg(self)

    def seekg(self, *args):
        return _Adaptor3d.istream_seekg(self, *args)

# Register istream in _Adaptor3d:
_Adaptor3d.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Adaptor3d.iostream_swiginit(self, _Adaptor3d.new_iostream(__sb))
    __swig_destroy__ = _Adaptor3d.delete_iostream

# Register iostream in _Adaptor3d:
_Adaptor3d.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _Adaptor3d.endl_cb_ptr
endl = _Adaptor3d.endl
ends_cb_ptr = _Adaptor3d.ends_cb_ptr
ends = _Adaptor3d.ends
flush_cb_ptr = _Adaptor3d.flush_cb_ptr
flush = _Adaptor3d.flush
