...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _XCAFPrs.ios_base_erase_event
    imbue_event = _XCAFPrs.ios_base_imbue_event
    copyfmt_event = _XCAFPrs.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _XCAFPrs.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _XCAFPrs.ios_base_flags(self, *args)

    def setf(self, *args):
        return _XCAFPrs.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _XCAFPrs.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _XCAFPrs.ios_base_precision(self, *args)

    def width(self, *args):
        return _XCAFPrs.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _XCAFPrs.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _XCAFPrs.ios_base_imbue(self, __loc)

    def getloc(self):
        return _XCAFPrs.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _XCAFPrs.ios_base_xalloc()

    def iword(self, __ix):
        return _XCAFPrs.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _XCAFPrs.ios_base_pword(self, __ix)
    __swig_destroy__ = _XCAFPrs.delete_ios_base

# Register ios_base in _XCAFPrs:
_XCAFPrs.ios_base_swigregister(ios_base)
cvar = _XCAFPrs.cvar
ios_base.boolalpha = _XCAFPrs.cvar.ios_base_boolalpha
ios_base.dec = _XCAFPrs.cvar.ios_base_dec
ios_base.fixed = _XCAFPrs.cvar.ios_base_fixed
ios_base.hex = _XCAFPrs.cvar.ios_base_hex
ios_base.internal = _XCAFPrs.cvar.ios_base_internal
ios_base.left = _XCAFPrs.cvar.ios_base_left
ios_base.oct = _XCAFPrs.cvar.ios_base_oct
ios_base.right = _XCAFPrs.cvar.ios_base_right
ios_base.scientific = _XCAFPrs.cvar.ios_base_scientific
ios_base.showbase = _XCAFPrs.cvar.ios_base_showbase
ios_base.showpoint = _XCAFPrs.cvar.ios_base_showpoint
ios_base.showpos = _XCAFPrs.cvar.ios_base_showpos
ios_base.skipws = _XCAFPrs.cvar.ios_base_skipws
ios_base.unitbuf = _XCAFPrs.cvar.ios_base_unitbuf
ios_base.uppercase = _XCAFPrs.cvar.ios_base_uppercase
ios_base.adjustfield = _XCAFPrs.cvar.ios_base_adjustfield
ios_base.basefield = _XCAFPrs.cvar.ios_base_basefield
ios_base.floatfield = _XCAFPrs.cvar.ios_base_floatfield
ios_base.badbit = _XCAFPrs.cvar.ios_base_badbit
ios_base.eofbit = _XCAFPrs.cvar.ios_base_eofbit
ios_base.failbit = _XCAFPrs.cvar.ios_base_failbit
ios_base.goodbit = _XCAFPrs.cvar.ios_base_goodbit
ios_base.app = _XCAFPrs.cvar.ios_base_app
ios_base.ate = _XCAFPrs.cvar.ios_base_ate
ios_base.binary = _XCAFPrs.cvar.ios_base_binary
ios_base.ios_base_in = _XCAFPrs.cvar.ios_base_ios_base_in
ios_base.out = _XCAFPrs.cvar.ios_base_out
ios_base.trunc = _XCAFPrs.cvar.ios_base_trunc
ios_base.beg = _XCAFPrs.cvar.ios_base_beg
ios_base.cur = _XCAFPrs.cvar.ios_base_cur
ios_base.end = _XCAFPrs.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _XCAFPrs.ios_rdstate(self)

    def clear(self, *args):
        return _XCAFPrs.ios_clear(self, *args)

    def setstate(self, __state):
        return _XCAFPrs.ios_setstate(self, __state)

    def good(self):
        return _XCAFPrs.ios_good(self)

    def eof(self):
        return _XCAFPrs.ios_eof(self)

    def fail(self):
        return _XCAFPrs.ios_fail(self)

    def bad(self):
        return _XCAFPrs.ios_bad(self)

    def exceptions(self, *args):
        return _XCAFPrs.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _XCAFPrs.ios_swiginit(self, _XCAFPrs.new_ios(__sb))
    __swig_destroy__ = _XCAFPrs.delete_ios

    def tie(self, *args):
        return _XCAFPrs.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _XCAFPrs.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _XCAFPrs.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _XCAFPrs.ios_fill(self, *args)

    def imbue(self, __loc):
        return _XCAFPrs.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _XCAFPrs.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _XCAFPrs.ios_widen(self, __c)

# Register ios in _XCAFPrs:
_XCAFPrs.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _XCAFPrs.ostream_swiginit(self, _XCAFPrs.new_ostream(__sb))
    __swig_destroy__ = _XCAFPrs.delete_ostream

    def __lshift__(self, *args):
        return _XCAFPrs.ostream___lshift__(self, *args)

    def put(self, __c):
        return _XCAFPrs.ostream_put(self, __c)

    def write(self, __s, __n):
        return _XCAFPrs.ostream_write(self, __s, __n)

    def flush(self):
        return _XCAFPrs.ostream_flush(self)

    def tellp(self):
        return _XCAFPrs.ostream_tellp(self)

    def seekp(self, *args):
        return _XCAFPrs.ostream_seekp(self, *args)

# Register ostream in _XCAFPrs:
_XCAFPrs.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _XCAFPrs.istream_swiginit(self, _XCAFPrs.new_istream(__sb))
    __swig_destroy__ = _XCAFPrs.delete_istream

    def __rshift__(self, *args):
        return _XCAFPrs.istream___rshift__(self, *args)

    def gcount(self):
        return _XCAFPrs.istream_gcount(self)

    def get(self, *args):
        return _XCAFPrs.istream_get(self, *args)

    def getline(self, *args):
        return _XCAFPrs.istream_getline(self, *args)

    def ignore(self, *args):
        return _XCAFPrs.istream_ignore(self, *args)

    def peek(self):
        return _XCAFPrs.istream_peek(self)

    def read(self, __s, __n):
        return _XCAFPrs.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _XCAFPrs.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _XCAFPrs.istream_putback(self, __c)

    def unget(self):
        return _XCAFPrs.istream_unget(self)

    def sync(self):
        return _XCAFPrs.istream_sync(self)

    def tellg(self):
        return _XCAFPrs.istream_tellg(self)

    def seekg(self, *args):
        return _XCAFPrs.istream_seekg(self, *args)

# Register istream in _XCAFPrs:
_XCAFPrs.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _XCAFPrs.iostream_swiginit(self, _XCAFPrs.new_iostream(__sb))
    __swig_destroy__ = _XCAFPrs.delete_iostream

# Register iostream in _XCAFPrs:
_XCAFPrs.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _XCAFPrs.endl_cb_ptr
endl = _XCAFPrs.endl
ends_cb_ptr = _XCAFPrs.ends_cb_ptr
ends = _XCAFPrs.ends
flush_cb_ptr = _XCAFPrs.flush_cb_ptr
flush = _XCAFPrs.flush
...
class XCAFPrs_DataMapOfStyleShape(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Bound(self, *args):
        return _XCAFPrs.XCAFPrs_DataMapOfStyleShape_Bound(self, *args)
...
class XCAFPrs_DataMapOfStyleTransient(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Bound(self, *args):
        return _XCAFPrs.XCAFPrs_DataMapOfStyleTransient_Bound(self, *args)
...
class XCAFPrs_IndexedDataMapOfShapeStyle(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _XCAFPrs.XCAFPrs_IndexedDataMapOfShapeStyle_Set(self, *args)

    def ReSize(self, N):
        return _XCAFPrs.XCAFPrs_IndexedDataMapOfShapeStyle_ReSize(self, N)

    def Add(self, *args):
        return _XCAFPrs.XCAFPrs_IndexedDataMapOfShapeStyle_Add(self, *args)
...
class XCAFPrs_DocumentNode(object):
    ...
    def __eq_wrapper__(self, other):
        return _XCAFPrs.XCAFPrs_DocumentNode___eq_wrapper__(self, other)
...
class XCAFPrs_Style(object):
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _XCAFPrs.XCAFPrs_Style_DumpJson(self, depth)
    ...
    def IsEqual(self, *args):
        ...
        """
        return _XCAFPrs.XCAFPrs_Style_IsEqual(self, *args)
