...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_plate.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _Plate.ios_base_erase_event
    imbue_event = _Plate.ios_base_imbue_event
    copyfmt_event = _Plate.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _Plate.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _Plate.ios_base_flags(self, *args)

    def setf(self, *args):
        return _Plate.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _Plate.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _Plate.ios_base_precision(self, *args)

    def width(self, *args):
        return _Plate.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _Plate.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _Plate.ios_base_imbue(self, __loc)

    def getloc(self):
        return _Plate.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _Plate.ios_base_xalloc()

    def iword(self, __ix):
        return _Plate.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _Plate.ios_base_pword(self, __ix)
    __swig_destroy__ = _Plate.delete_ios_base

# Register ios_base in _Plate:
_Plate.ios_base_swigregister(ios_base)
cvar = _Plate.cvar
ios_base.boolalpha = _Plate.cvar.ios_base_boolalpha
ios_base.dec = _Plate.cvar.ios_base_dec
ios_base.fixed = _Plate.cvar.ios_base_fixed
ios_base.hex = _Plate.cvar.ios_base_hex
ios_base.internal = _Plate.cvar.ios_base_internal
ios_base.left = _Plate.cvar.ios_base_left
ios_base.oct = _Plate.cvar.ios_base_oct
ios_base.right = _Plate.cvar.ios_base_right
ios_base.scientific = _Plate.cvar.ios_base_scientific
ios_base.showbase = _Plate.cvar.ios_base_showbase
ios_base.showpoint = _Plate.cvar.ios_base_showpoint
ios_base.showpos = _Plate.cvar.ios_base_showpos
ios_base.skipws = _Plate.cvar.ios_base_skipws
ios_base.unitbuf = _Plate.cvar.ios_base_unitbuf
ios_base.uppercase = _Plate.cvar.ios_base_uppercase
ios_base.adjustfield = _Plate.cvar.ios_base_adjustfield
ios_base.basefield = _Plate.cvar.ios_base_basefield
ios_base.floatfield = _Plate.cvar.ios_base_floatfield
ios_base.badbit = _Plate.cvar.ios_base_badbit
ios_base.eofbit = _Plate.cvar.ios_base_eofbit
ios_base.failbit = _Plate.cvar.ios_base_failbit
ios_base.goodbit = _Plate.cvar.ios_base_goodbit
ios_base.app = _Plate.cvar.ios_base_app
ios_base.ate = _Plate.cvar.ios_base_ate
ios_base.binary = _Plate.cvar.ios_base_binary
ios_base.ios_base_in = _Plate.cvar.ios_base_ios_base_in
ios_base.out = _Plate.cvar.ios_base_out
ios_base.trunc = _Plate.cvar.ios_base_trunc
ios_base.beg = _Plate.cvar.ios_base_beg
ios_base.cur = _Plate.cvar.ios_base_cur
ios_base.end = _Plate.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _Plate.ios_rdstate(self)

    def clear(self, *args):
        return _Plate.ios_clear(self, *args)

    def setstate(self, __state):
        return _Plate.ios_setstate(self, __state)

    def good(self):
        return _Plate.ios_good(self)

    def eof(self):
        return _Plate.ios_eof(self)

    def fail(self):
        return _Plate.ios_fail(self)

    def bad(self):
        return _Plate.ios_bad(self)

    def exceptions(self, *args):
        return _Plate.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _Plate.ios_swiginit(self, _Plate.new_ios(__sb))
    __swig_destroy__ = _Plate.delete_ios

    def tie(self, *args):
        return _Plate.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _Plate.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _Plate.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _Plate.ios_fill(self, *args)

    def imbue(self, __loc):
        return _Plate.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _Plate.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _Plate.ios_widen(self, __c)

# Register ios in _Plate:
_Plate.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Plate.ostream_swiginit(self, _Plate.new_ostream(__sb))
    __swig_destroy__ = _Plate.delete_ostream

    def __lshift__(self, *args):
        return _Plate.ostream___lshift__(self, *args)

    def put(self, __c):
        return _Plate.ostream_put(self, __c)

    def write(self, __s, __n):
        return _Plate.ostream_write(self, __s, __n)

    def flush(self):
        return _Plate.ostream_flush(self)

    def tellp(self):
        return _Plate.ostream_tellp(self)

    def seekp(self, *args):
        return _Plate.ostream_seekp(self, *args)

# Register ostream in _Plate:
_Plate.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Plate.istream_swiginit(self, _Plate.new_istream(__sb))
    __swig_destroy__ = _Plate.delete_istream

    def __rshift__(self, *args):
        return _Plate.istream___rshift__(self, *args)

    def gcount(self):
        return _Plate.istream_gcount(self)

    def get(self, *args):
        return _Plate.istream_get(self, *args)

    def getline(self, *args):
        return _Plate.istream_getline(self, *args)

    def ignore(self, *args):
        return _Plate.istream_ignore(self, *args)

    def peek(self):
        return _Plate.istream_peek(self)

    def read(self, __s, __n):
        return _Plate.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _Plate.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _Plate.istream_putback(self, __c)

    def unget(self):
        return _Plate.istream_unget(self)

    def sync(self):
        return _Plate.istream_sync(self)

    def tellg(self):
        return _Plate.istream_tellg(self)

    def seekg(self, *args):
        return _Plate.istream_seekg(self, *args)

# Register istream in _Plate:
_Plate.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _Plate.iostream_swiginit(self, _Plate.new_iostream(__sb))
    __swig_destroy__ = _Plate.delete_iostream

# Register iostream in _Plate:
_Plate.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _Plate.endl_cb_ptr
endl = _Plate.endl
ends_cb_ptr = _Plate.ends_cb_ptr
ends = _Plate.ends
flush_cb_ptr = _Plate.flush_cb_ptr
flush = _Plate.flush
...
class Plate_Array1OfPinpointConstraint(object):
    ...
    def begin(self, *args):
        return _Plate.Plate_Array1OfPinpointConstraint_begin(self, *args)

    def cbegin(self):
        return _Plate.Plate_Array1OfPinpointConstraint_cbegin(self)

    def end(self, *args):
        return _Plate.Plate_Array1OfPinpointConstraint_end(self, *args)
    ...
    def Move(self, *args):
        return _Plate.Plate_Array1OfPinpointConstraint_Move(self, *args)
    ...
    def UpdateLowerBound(self, theLower):
        return _Plate.Plate_Array1OfPinpointConstraint_UpdateLowerBound(self, theLower)

    def UpdateUpperBound(self, theUpper):
        return _Plate.Plate_Array1OfPinpointConstraint_UpdateUpperBound(self, theUpper)
