...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_exprintrp.html
"""
...
class ExprIntrp_StackOfGeneralFunction(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
