...
process_exception = _AppStd.process_exception
...
def Handle_AppStd_Application_Create() -> "opencascade::handle< AppStd_Application >":
    return _AppStd.Handle_AppStd_Application_Create()
Handle_AppStd_Application_Create = _AppStd.Handle_AppStd_Application_Create

def Handle_AppStd_Application_DownCast(t: 'opencascade::handle< Standard_Transient > const &') -> "opencascade::handle< AppStd_Application >":
...
def Handle_AppStd_Application_IsNull(t: 'opencascade::handle< AppStd_Application > const &') -> "bool":
    return _AppStd.Handle_AppStd_Application_IsNull(t)
Handle_AppStd_Application_IsNull = _AppStd.Handle_AppStd_Application_IsNull
class AppStd_Application(OCC.Core.TDocStd.TDocStd_Application):
    __swig_setmethods__ = {}
    for _s in [OCC.Core.TDocStd.TDocStd_Application]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, AppStd_Application, name, value)
    __swig_getmethods__ = {}
    for _s in [OCC.Core.TDocStd.TDocStd_Application]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, AppStd_Application, name)
    __repr__ = _swig_repr

    def DumpJsonToString(self, depth: 'int'=-1) -> "std::string":
        """
        DumpJsonToString(AppStd_Application self, int depth=-1) -> std::string
        DumpJsonToString(AppStd_Application self) -> std::string
        """
        return _AppStd.AppStd_Application_DumpJsonToString(self, depth)
    ...
    def __init__(self):
        """__init__(AppStd_Application self) -> AppStd_Application"""
