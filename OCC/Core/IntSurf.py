...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _IntSurf.ios_base_erase_event
    imbue_event = _IntSurf.ios_base_imbue_event
    copyfmt_event = _IntSurf.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _IntSurf.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _IntSurf.ios_base_flags(self, *args)

    def setf(self, *args):
        return _IntSurf.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _IntSurf.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _IntSurf.ios_base_precision(self, *args)

    def width(self, *args):
        return _IntSurf.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _IntSurf.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _IntSurf.ios_base_imbue(self, __loc)

    def getloc(self):
        return _IntSurf.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _IntSurf.ios_base_xalloc()

    def iword(self, __ix):
        return _IntSurf.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _IntSurf.ios_base_pword(self, __ix)
    __swig_destroy__ = _IntSurf.delete_ios_base

# Register ios_base in _IntSurf:
_IntSurf.ios_base_swigregister(ios_base)
cvar = _IntSurf.cvar
ios_base.boolalpha = _IntSurf.cvar.ios_base_boolalpha
ios_base.dec = _IntSurf.cvar.ios_base_dec
ios_base.fixed = _IntSurf.cvar.ios_base_fixed
ios_base.hex = _IntSurf.cvar.ios_base_hex
ios_base.internal = _IntSurf.cvar.ios_base_internal
ios_base.left = _IntSurf.cvar.ios_base_left
ios_base.oct = _IntSurf.cvar.ios_base_oct
ios_base.right = _IntSurf.cvar.ios_base_right
ios_base.scientific = _IntSurf.cvar.ios_base_scientific
ios_base.showbase = _IntSurf.cvar.ios_base_showbase
ios_base.showpoint = _IntSurf.cvar.ios_base_showpoint
ios_base.showpos = _IntSurf.cvar.ios_base_showpos
ios_base.skipws = _IntSurf.cvar.ios_base_skipws
ios_base.unitbuf = _IntSurf.cvar.ios_base_unitbuf
ios_base.uppercase = _IntSurf.cvar.ios_base_uppercase
ios_base.adjustfield = _IntSurf.cvar.ios_base_adjustfield
ios_base.basefield = _IntSurf.cvar.ios_base_basefield
ios_base.floatfield = _IntSurf.cvar.ios_base_floatfield
ios_base.badbit = _IntSurf.cvar.ios_base_badbit
ios_base.eofbit = _IntSurf.cvar.ios_base_eofbit
ios_base.failbit = _IntSurf.cvar.ios_base_failbit
ios_base.goodbit = _IntSurf.cvar.ios_base_goodbit
ios_base.app = _IntSurf.cvar.ios_base_app
ios_base.ate = _IntSurf.cvar.ios_base_ate
ios_base.binary = _IntSurf.cvar.ios_base_binary
ios_base.ios_base_in = _IntSurf.cvar.ios_base_ios_base_in
ios_base.out = _IntSurf.cvar.ios_base_out
ios_base.trunc = _IntSurf.cvar.ios_base_trunc
ios_base.beg = _IntSurf.cvar.ios_base_beg
ios_base.cur = _IntSurf.cvar.ios_base_cur
ios_base.end = _IntSurf.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _IntSurf.ios_rdstate(self)

    def clear(self, *args):
        return _IntSurf.ios_clear(self, *args)

    def setstate(self, __state):
        return _IntSurf.ios_setstate(self, __state)

    def good(self):
        return _IntSurf.ios_good(self)

    def eof(self):
        return _IntSurf.ios_eof(self)

    def fail(self):
        return _IntSurf.ios_fail(self)

    def bad(self):
        return _IntSurf.ios_bad(self)

    def exceptions(self, *args):
        return _IntSurf.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _IntSurf.ios_swiginit(self, _IntSurf.new_ios(__sb))
    __swig_destroy__ = _IntSurf.delete_ios

    def tie(self, *args):
        return _IntSurf.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _IntSurf.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _IntSurf.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _IntSurf.ios_fill(self, *args)

    def imbue(self, __loc):
        return _IntSurf.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _IntSurf.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _IntSurf.ios_widen(self, __c)

# Register ios in _IntSurf:
_IntSurf.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _IntSurf.ostream_swiginit(self, _IntSurf.new_ostream(__sb))
    __swig_destroy__ = _IntSurf.delete_ostream

    def __lshift__(self, *args):
        return _IntSurf.ostream___lshift__(self, *args)

    def put(self, __c):
        return _IntSurf.ostream_put(self, __c)

    def write(self, __s, __n):
        return _IntSurf.ostream_write(self, __s, __n)

    def flush(self):
        return _IntSurf.ostream_flush(self)

    def tellp(self):
        return _IntSurf.ostream_tellp(self)

    def seekp(self, *args):
        return _IntSurf.ostream_seekp(self, *args)

# Register ostream in _IntSurf:
_IntSurf.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _IntSurf.istream_swiginit(self, _IntSurf.new_istream(__sb))
    __swig_destroy__ = _IntSurf.delete_istream

    def __rshift__(self, *args):
        return _IntSurf.istream___rshift__(self, *args)

    def gcount(self):
        return _IntSurf.istream_gcount(self)

    def get(self, *args):
        return _IntSurf.istream_get(self, *args)

    def getline(self, *args):
        return _IntSurf.istream_getline(self, *args)

    def ignore(self, *args):
        return _IntSurf.istream_ignore(self, *args)

    def peek(self):
        return _IntSurf.istream_peek(self)

    def read(self, __s, __n):
        return _IntSurf.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _IntSurf.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _IntSurf.istream_putback(self, __c)

    def unget(self):
        return _IntSurf.istream_unget(self)

    def sync(self):
        return _IntSurf.istream_sync(self)

    def tellg(self):
        return _IntSurf.istream_tellg(self)

    def seekg(self, *args):
        return _IntSurf.istream_seekg(self, *args)

# Register istream in _IntSurf:
_IntSurf.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _IntSurf.iostream_swiginit(self, _IntSurf.new_iostream(__sb))
    __swig_destroy__ = _IntSurf.delete_iostream

# Register iostream in _IntSurf:
_IntSurf.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _IntSurf.endl_cb_ptr
endl = _IntSurf.endl
ends_cb_ptr = _IntSurf.ends_cb_ptr
ends = _IntSurf.ends
flush_cb_ptr = _IntSurf.flush_cb_ptr
flush = _IntSurf.flush
...
class IntSurf_ListOfPntOn2S(OCC.Core.NCollection.NCollection_BaseList):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class IntSurf_SequenceOfPntOn2S(object):
    ...
    def Set(self, *args):
        return _IntSurf.IntSurf_SequenceOfPntOn2S_Set(self, *args)
