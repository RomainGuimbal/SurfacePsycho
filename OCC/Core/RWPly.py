...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_rwply.html
"""
...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _RWPly.ios_base_erase_event
    imbue_event = _RWPly.ios_base_imbue_event
    copyfmt_event = _RWPly.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _RWPly.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _RWPly.ios_base_flags(self, *args)

    def setf(self, *args):
        return _RWPly.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _RWPly.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _RWPly.ios_base_precision(self, *args)

    def width(self, *args):
        return _RWPly.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _RWPly.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _RWPly.ios_base_imbue(self, __loc)

    def getloc(self):
        return _RWPly.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _RWPly.ios_base_xalloc()

    def iword(self, __ix):
        return _RWPly.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _RWPly.ios_base_pword(self, __ix)
    __swig_destroy__ = _RWPly.delete_ios_base

# Register ios_base in _RWPly:
_RWPly.ios_base_swigregister(ios_base)
cvar = _RWPly.cvar
ios_base.boolalpha = _RWPly.cvar.ios_base_boolalpha
ios_base.dec = _RWPly.cvar.ios_base_dec
ios_base.fixed = _RWPly.cvar.ios_base_fixed
ios_base.hex = _RWPly.cvar.ios_base_hex
ios_base.internal = _RWPly.cvar.ios_base_internal
ios_base.left = _RWPly.cvar.ios_base_left
ios_base.oct = _RWPly.cvar.ios_base_oct
ios_base.right = _RWPly.cvar.ios_base_right
ios_base.scientific = _RWPly.cvar.ios_base_scientific
ios_base.showbase = _RWPly.cvar.ios_base_showbase
ios_base.showpoint = _RWPly.cvar.ios_base_showpoint
ios_base.showpos = _RWPly.cvar.ios_base_showpos
ios_base.skipws = _RWPly.cvar.ios_base_skipws
ios_base.unitbuf = _RWPly.cvar.ios_base_unitbuf
ios_base.uppercase = _RWPly.cvar.ios_base_uppercase
ios_base.adjustfield = _RWPly.cvar.ios_base_adjustfield
ios_base.basefield = _RWPly.cvar.ios_base_basefield
ios_base.floatfield = _RWPly.cvar.ios_base_floatfield
ios_base.badbit = _RWPly.cvar.ios_base_badbit
ios_base.eofbit = _RWPly.cvar.ios_base_eofbit
ios_base.failbit = _RWPly.cvar.ios_base_failbit
ios_base.goodbit = _RWPly.cvar.ios_base_goodbit
ios_base.app = _RWPly.cvar.ios_base_app
ios_base.ate = _RWPly.cvar.ios_base_ate
ios_base.binary = _RWPly.cvar.ios_base_binary
ios_base.ios_base_in = _RWPly.cvar.ios_base_ios_base_in
ios_base.out = _RWPly.cvar.ios_base_out
ios_base.trunc = _RWPly.cvar.ios_base_trunc
ios_base.beg = _RWPly.cvar.ios_base_beg
ios_base.cur = _RWPly.cvar.ios_base_cur
ios_base.end = _RWPly.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _RWPly.ios_rdstate(self)

    def clear(self, *args):
        return _RWPly.ios_clear(self, *args)

    def setstate(self, __state):
        return _RWPly.ios_setstate(self, __state)

    def good(self):
        return _RWPly.ios_good(self)

    def eof(self):
        return _RWPly.ios_eof(self)

    def fail(self):
        return _RWPly.ios_fail(self)

    def bad(self):
        return _RWPly.ios_bad(self)

    def exceptions(self, *args):
        return _RWPly.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _RWPly.ios_swiginit(self, _RWPly.new_ios(__sb))
    __swig_destroy__ = _RWPly.delete_ios

    def tie(self, *args):
        return _RWPly.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _RWPly.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _RWPly.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _RWPly.ios_fill(self, *args)

    def imbue(self, __loc):
        return _RWPly.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _RWPly.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _RWPly.ios_widen(self, __c)

# Register ios in _RWPly:
_RWPly.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _RWPly.ostream_swiginit(self, _RWPly.new_ostream(__sb))
    __swig_destroy__ = _RWPly.delete_ostream

    def __lshift__(self, *args):
        return _RWPly.ostream___lshift__(self, *args)

    def put(self, __c):
        return _RWPly.ostream_put(self, __c)

    def write(self, __s, __n):
        return _RWPly.ostream_write(self, __s, __n)

    def flush(self):
        return _RWPly.ostream_flush(self)

    def tellp(self):
        return _RWPly.ostream_tellp(self)

    def seekp(self, *args):
        return _RWPly.ostream_seekp(self, *args)

# Register ostream in _RWPly:
_RWPly.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _RWPly.istream_swiginit(self, _RWPly.new_istream(__sb))
    __swig_destroy__ = _RWPly.delete_istream

    def __rshift__(self, *args):
        return _RWPly.istream___rshift__(self, *args)

    def gcount(self):
        return _RWPly.istream_gcount(self)

    def get(self, *args):
        return _RWPly.istream_get(self, *args)

    def getline(self, *args):
        return _RWPly.istream_getline(self, *args)

    def ignore(self, *args):
        return _RWPly.istream_ignore(self, *args)

    def peek(self):
        return _RWPly.istream_peek(self)

    def read(self, __s, __n):
        return _RWPly.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _RWPly.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _RWPly.istream_putback(self, __c)

    def unget(self):
        return _RWPly.istream_unget(self)

    def sync(self):
        return _RWPly.istream_sync(self)

    def tellg(self):
        return _RWPly.istream_tellg(self)

    def seekg(self, *args):
        return _RWPly.istream_seekg(self, *args)

# Register istream in _RWPly:
_RWPly.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _RWPly.iostream_swiginit(self, _RWPly.new_iostream(__sb))
    __swig_destroy__ = _RWPly.delete_iostream

# Register iostream in _RWPly:
_RWPly.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _RWPly.endl_cb_ptr
endl = _RWPly.endl
ends_cb_ptr = _RWPly.ends_cb_ptr
ends = _RWPly.ends
flush_cb_ptr = _RWPly.flush_cb_ptr
flush = _RWPly.flush
