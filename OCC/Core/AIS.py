...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_ais.html
"""
...
class AIS_ColoredDrawer(OCC.Core.Prs3d.Prs3d_Drawer):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    myIsHidden = property(_AIS.AIS_ColoredDrawer_myIsHidden_get, _AIS.AIS_ColoredDrawer_myIsHidden_set)
    myHasOwnMaterial = property(_AIS.AIS_ColoredDrawer_myHasOwnMaterial_get, _AIS.AIS_ColoredDrawer_myHasOwnMaterial_set)
    myHasOwnColor = property(_AIS.AIS_ColoredDrawer_myHasOwnColor_get, _AIS.AIS_ColoredDrawer_myHasOwnColor_set)
    myHasOwnTransp = property(_AIS.AIS_ColoredDrawer_myHasOwnTransp_get, _AIS.AIS_ColoredDrawer_myHasOwnTransp_set)
    myHasOwnWidth = property(_AIS.AIS_ColoredDrawer_myHasOwnWidth_get, _AIS.AIS_ColoredDrawer_myHasOwnWidth_set)
