...
https://dev.opencascade.org/doc/occt-7.7.0/refman/html/package_cdf.html
"""
...
class CDF_Application(OCC.Core.CDM.CDM_Application):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    myMetaDataDriver = property(_CDF.CDF_Application_myMetaDataDriver_get, _CDF.CDF_Application_myMetaDataDriver_set)
    myDirectory = property(_CDF.CDF_Application_myDirectory_get, _CDF.CDF_Application_myDirectory_set)
