...
class ios_base(object):
    ...
    __repr__ = _swig_repr
    erase_event = _StepToTopoDS.ios_base_erase_event
    imbue_event = _StepToTopoDS.ios_base_imbue_event
    copyfmt_event = _StepToTopoDS.ios_base_copyfmt_event

    def register_callback(self, __fn, __index):
        return _StepToTopoDS.ios_base_register_callback(self, __fn, __index)

    def flags(self, *args):
        return _StepToTopoDS.ios_base_flags(self, *args)

    def setf(self, *args):
        return _StepToTopoDS.ios_base_setf(self, *args)

    def unsetf(self, __mask):
        return _StepToTopoDS.ios_base_unsetf(self, __mask)

    def precision(self, *args):
        return _StepToTopoDS.ios_base_precision(self, *args)

    def width(self, *args):
        return _StepToTopoDS.ios_base_width(self, *args)

    @staticmethod
    def sync_with_stdio(__sync=True):
        return _StepToTopoDS.ios_base_sync_with_stdio(__sync)

    def imbue(self, __loc):
        return _StepToTopoDS.ios_base_imbue(self, __loc)

    def getloc(self):
        return _StepToTopoDS.ios_base_getloc(self)

    @staticmethod
    def xalloc():
        return _StepToTopoDS.ios_base_xalloc()

    def iword(self, __ix):
        return _StepToTopoDS.ios_base_iword(self, __ix)

    def pword(self, __ix):
        return _StepToTopoDS.ios_base_pword(self, __ix)
    __swig_destroy__ = _StepToTopoDS.delete_ios_base

# Register ios_base in _StepToTopoDS:
_StepToTopoDS.ios_base_swigregister(ios_base)
cvar = _StepToTopoDS.cvar
ios_base.boolalpha = _StepToTopoDS.cvar.ios_base_boolalpha
ios_base.dec = _StepToTopoDS.cvar.ios_base_dec
ios_base.fixed = _StepToTopoDS.cvar.ios_base_fixed
ios_base.hex = _StepToTopoDS.cvar.ios_base_hex
ios_base.internal = _StepToTopoDS.cvar.ios_base_internal
ios_base.left = _StepToTopoDS.cvar.ios_base_left
ios_base.oct = _StepToTopoDS.cvar.ios_base_oct
ios_base.right = _StepToTopoDS.cvar.ios_base_right
ios_base.scientific = _StepToTopoDS.cvar.ios_base_scientific
ios_base.showbase = _StepToTopoDS.cvar.ios_base_showbase
ios_base.showpoint = _StepToTopoDS.cvar.ios_base_showpoint
ios_base.showpos = _StepToTopoDS.cvar.ios_base_showpos
ios_base.skipws = _StepToTopoDS.cvar.ios_base_skipws
ios_base.unitbuf = _StepToTopoDS.cvar.ios_base_unitbuf
ios_base.uppercase = _StepToTopoDS.cvar.ios_base_uppercase
ios_base.adjustfield = _StepToTopoDS.cvar.ios_base_adjustfield
ios_base.basefield = _StepToTopoDS.cvar.ios_base_basefield
ios_base.floatfield = _StepToTopoDS.cvar.ios_base_floatfield
ios_base.badbit = _StepToTopoDS.cvar.ios_base_badbit
ios_base.eofbit = _StepToTopoDS.cvar.ios_base_eofbit
ios_base.failbit = _StepToTopoDS.cvar.ios_base_failbit
ios_base.goodbit = _StepToTopoDS.cvar.ios_base_goodbit
ios_base.app = _StepToTopoDS.cvar.ios_base_app
ios_base.ate = _StepToTopoDS.cvar.ios_base_ate
ios_base.binary = _StepToTopoDS.cvar.ios_base_binary
ios_base.ios_base_in = _StepToTopoDS.cvar.ios_base_ios_base_in
ios_base.out = _StepToTopoDS.cvar.ios_base_out
ios_base.trunc = _StepToTopoDS.cvar.ios_base_trunc
ios_base.beg = _StepToTopoDS.cvar.ios_base_beg
ios_base.cur = _StepToTopoDS.cvar.ios_base_cur
ios_base.end = _StepToTopoDS.cvar.ios_base_end
...
class ios(ios_base):
    ...
    def rdstate(self):
        return _StepToTopoDS.ios_rdstate(self)

    def clear(self, *args):
        return _StepToTopoDS.ios_clear(self, *args)

    def setstate(self, __state):
        return _StepToTopoDS.ios_setstate(self, __state)

    def good(self):
        return _StepToTopoDS.ios_good(self)

    def eof(self):
        return _StepToTopoDS.ios_eof(self)

    def fail(self):
        return _StepToTopoDS.ios_fail(self)

    def bad(self):
        return _StepToTopoDS.ios_bad(self)

    def exceptions(self, *args):
        return _StepToTopoDS.ios_exceptions(self, *args)

    def __init__(self, __sb):
        _StepToTopoDS.ios_swiginit(self, _StepToTopoDS.new_ios(__sb))
    __swig_destroy__ = _StepToTopoDS.delete_ios

    def tie(self, *args):
        return _StepToTopoDS.ios_tie(self, *args)

    def rdbuf(self, *args):
        return _StepToTopoDS.ios_rdbuf(self, *args)

    def copyfmt(self, __rhs):
        return _StepToTopoDS.ios_copyfmt(self, __rhs)

    def fill(self, *args):
        return _StepToTopoDS.ios_fill(self, *args)

    def imbue(self, __loc):
        return _StepToTopoDS.ios_imbue(self, __loc)

    def narrow(self, __c, __dfault):
        return _StepToTopoDS.ios_narrow(self, __c, __dfault)

    def widen(self, __c):
        return _StepToTopoDS.ios_widen(self, __c)

# Register ios in _StepToTopoDS:
_StepToTopoDS.ios_swigregister(ios)
class ostream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _StepToTopoDS.ostream_swiginit(self, _StepToTopoDS.new_ostream(__sb))
    __swig_destroy__ = _StepToTopoDS.delete_ostream

    def __lshift__(self, *args):
        return _StepToTopoDS.ostream___lshift__(self, *args)

    def put(self, __c):
        return _StepToTopoDS.ostream_put(self, __c)

    def write(self, __s, __n):
        return _StepToTopoDS.ostream_write(self, __s, __n)

    def flush(self):
        return _StepToTopoDS.ostream_flush(self)

    def tellp(self):
        return _StepToTopoDS.ostream_tellp(self)

    def seekp(self, *args):
        return _StepToTopoDS.ostream_seekp(self, *args)

# Register ostream in _StepToTopoDS:
_StepToTopoDS.ostream_swigregister(ostream)
class istream(ios):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _StepToTopoDS.istream_swiginit(self, _StepToTopoDS.new_istream(__sb))
    __swig_destroy__ = _StepToTopoDS.delete_istream

    def __rshift__(self, *args):
        return _StepToTopoDS.istream___rshift__(self, *args)

    def gcount(self):
        return _StepToTopoDS.istream_gcount(self)

    def get(self, *args):
        return _StepToTopoDS.istream_get(self, *args)

    def getline(self, *args):
        return _StepToTopoDS.istream_getline(self, *args)

    def ignore(self, *args):
        return _StepToTopoDS.istream_ignore(self, *args)

    def peek(self):
        return _StepToTopoDS.istream_peek(self)

    def read(self, __s, __n):
        return _StepToTopoDS.istream_read(self, __s, __n)

    def readsome(self, __s, __n):
        return _StepToTopoDS.istream_readsome(self, __s, __n)

    def putback(self, __c):
        return _StepToTopoDS.istream_putback(self, __c)

    def unget(self):
        return _StepToTopoDS.istream_unget(self)

    def sync(self):
        return _StepToTopoDS.istream_sync(self)

    def tellg(self):
        return _StepToTopoDS.istream_tellg(self)

    def seekg(self, *args):
        return _StepToTopoDS.istream_seekg(self, *args)

# Register istream in _StepToTopoDS:
_StepToTopoDS.istream_swigregister(istream)
class iostream(istream, ostream):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, __sb):
        _StepToTopoDS.iostream_swiginit(self, _StepToTopoDS.new_iostream(__sb))
    __swig_destroy__ = _StepToTopoDS.delete_iostream

# Register iostream in _StepToTopoDS:
_StepToTopoDS.iostream_swigregister(iostream)
cin = cvar.cin
cout = cvar.cout
cerr = cvar.cerr
clog = cvar.clog

endl_cb_ptr = _StepToTopoDS.endl_cb_ptr
endl = _StepToTopoDS.endl
ends_cb_ptr = _StepToTopoDS.ends_cb_ptr
ends = _StepToTopoDS.ends
flush_cb_ptr = _StepToTopoDS.flush_cb_ptr
flush = _StepToTopoDS.flush
...
class StepToTopoDS_DataMapOfRI(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRI_Set(self, *args)

    def ReSize(self, N):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRI_ReSize(self, N)

    def Bind(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRI_Bind(self, *args)

    def Bound(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRI_Bound(self, *args)
...
class StepToTopoDS_DataMapOfRINames(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRINames_Set(self, *args)

    def ReSize(self, N):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRINames_ReSize(self, N)

    def Bind(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRINames_Bind(self, *args)

    def Bound(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfRINames_Bound(self, *args)
...
class StepToTopoDS_DataMapOfTRI(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfTRI_Set(self, *args)

    def ReSize(self, N):
        return _StepToTopoDS.StepToTopoDS_DataMapOfTRI_ReSize(self, N)

    def Bind(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfTRI_Bind(self, *args)

    def Bound(self, *args):
        return _StepToTopoDS.StepToTopoDS_DataMapOfTRI_Bound(self, *args)
...
class StepToTopoDS_PointEdgeMap(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _StepToTopoDS.StepToTopoDS_PointEdgeMap_Set(self, *args)

    def ReSize(self, N):
        return _StepToTopoDS.StepToTopoDS_PointEdgeMap_ReSize(self, N)

    def Bind(self, *args):
        return _StepToTopoDS.StepToTopoDS_PointEdgeMap_Bind(self, *args)

    def Bound(self, *args):
        return _StepToTopoDS.StepToTopoDS_PointEdgeMap_Bound(self, *args)
...
class StepToTopoDS_PointVertexMap(OCC.Core.NCollection.NCollection_BaseMap):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def Set(self, *args):
        return _StepToTopoDS.StepToTopoDS_PointVertexMap_Set(self, *args)

    def ReSize(self, N):
        return _StepToTopoDS.StepToTopoDS_PointVertexMap_ReSize(self, N)

    def Bind(self, *args):
        return _StepToTopoDS.StepToTopoDS_PointVertexMap_Bind(self, *args)

    def Bound(self, *args):
        return _StepToTopoDS.StepToTopoDS_PointVertexMap_Bound(self, *args)
...
class StepToTopoDS_PointPair(object):
    ...
    def GetPoint1(self, *args):
        ...
        """
        return _StepToTopoDS.StepToTopoDS_PointPair_GetPoint1(self, *args)
    ...
    def GetPoint2(self, *args):
        ...
        """
        return _StepToTopoDS.StepToTopoDS_PointPair_GetPoint2(self, *args)

    def __eq_wrapper__(self, other):
        return _StepToTopoDS.StepToTopoDS_PointPair___eq_wrapper__(self, other)
